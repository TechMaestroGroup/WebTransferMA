define(function () {
  ...
  function AddBeneficiaryUtility(){
     this.map = {};
}
 /**
     ...
     */
    AddBeneficiaryUtility.prototype.breakPointParser = function(inputJSON, lookUpKey) {
      try{
      ...
      if(inputJSON.hasOwnProperty(lookUpKey)){
        if(typeof(inputJSON[lookUpKey]) == "string"){
         return inputJSON[lookUpKey];
        }
        else{
           return inputJSON[lookUpKey]['skin'];
        }
      }
      else if(inputJSON["default"]){
        if(typeof(inputJSON["default"]) == "string"){
         return inputJSON["default"];
        }
        else{
           return inputJSON["default"]['skin'];
        }
      }
      return inputJSON;
    },
     ...
     */
    AddBeneficiaryUtility.prototype.setFormattedData = function(formatValues, text, type) {
  ...
  */
    AddBeneficiaryUtility.prototype.buttonParsedValue = function(property) {
      var parsedValue="";
      try{
  ...
  */
    AddBeneficiaryUtility.prototype.retrieveEntitlement = function(property) {
      var parsedJson = "";
      var parsedValue = "";
      try{
     ...
     * @return : NA
     */
    AddBeneficiaryUtility.prototype.readArray = function(array, jsonPath) {
     ...
     * @return : NA
     */
     AddBeneficiaryUtility.prototype.readObject = function(obj, jsonPath) {
