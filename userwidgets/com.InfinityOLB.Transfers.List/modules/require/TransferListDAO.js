define(function () {
  ...
  /**
     ...
     */
  TransferListDAO.prototype.fetchTransactionList = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    ...
    var errorCallback = function(error) {
     var errObj = {
            "errorInfo" : "Failed to fetch  Details.",
            "error": error
          };
          onError(errObj);
    };
  ...
  /**
     ...
     */
  TransferListDAO.prototype.searchBeneficiaries = function(objServiceName,operationName,objName,criteria,responsePath,onSuccess,onError) {
    kony.application.showLoadingScreen("loadingskin","Data is still Loading");
    var objSvc = kony.sdk.getCurrentInstance().getObjectService(objServiceName, {
        "access": "online"
    });
...
/**
     ...
     * @param :         {string}  - unique code to identify service reposne in case of multiple service calls
     */
  TransferListDAO.prototype.deleteBeneficiary = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    kony.application.showLoadingScreen("loadingskin","Data is still Loading");
    var objSvc = kony.sdk.getCurrentInstance().getObjectService(objServiceName, {
        "access": "online"
    });
