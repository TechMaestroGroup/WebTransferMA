define(function () {
 ...
 /**
     ...
     */
    ConfirmationUtility.prototype.breakPointParser = function(inputJSON, lookUpKey) {
     ...
     */
    ConfirmationUtility.prototype.setFormattedData = function(formatValues, text, type) {
  ...
  */
    ConfirmationUtility.prototype.buttonParsedValue = function(property) {
      var parsedValue="";
      try{
  ...
  */
    ConfirmationUtility.prototype.retrieveEntitlement = function(property) {
      var parsedJson = "";
      var parsedValue = "";
      try{
     ...
     * @return : NA
     */
    ConfirmationUtility.prototype.readArray = function(array, jsonPath) {
     ...
     * @return : NA
     */
     ConfirmationUtility.prototype.readObject = function(obj, jsonPath) {
