  ...
  return {
    ...
    */
    ...
    setUIData: function () {
      ...
      for (var i = 1; i <= 28; i++) {
        ...
        if (valueLabel && flex) {
          ...
          if (!val || val.trim() === "" || val.trim().toLowerCase() === "none") {
    ...
    setEndDate: function () {
      ...
      try {
        ...
        var startDate = this.businessController.getDataBasedOnDataMapping("lblValue8"); //Start Date
        var frequency = this.businessController.getDataBasedOnDataMapping("lblValue7"); //Frequency
        var noofDays = 0;
    ...
    */
    initActionsOfButtons: function () {
      ...
      this.view.btnAction3.onClick = function () {
        if(scope.context.Transaction.transferType === "AWACH Transfer"){
          scope.setAcknowledgement();
        } else if (scope.context.Transaction.transferType === "MPESA Transfer"){
          var payload = {
          ...
          scope.businessController.mpesaPayment(payload, scope.mpesaPaymentSuccess, scope.mpesaPaymentError);
        }
        else if (scope.context.Transaction.transferType === "MPESA Trust Transfer"){
          var payload = {
            "debitAcct": scope.context.Transaction.fromAccountNumber,
            "debitAmount": scope.context.Transaction.amount,
          ...
          scope.businessController.mpesaTrustPayment(payload, scope.mpesaTrustPaymentSuccess, scope.mpesaTrustPaymentError);
        }
        else if (scope.context.Transaction.transferType === "Telebirr Transfer"){
          var payload = {
            "debitAcct": scope.context.Transaction.fromAccountNumber,
            "debitAmount": scope.context.Transaction.amount,
            "phone": scope.context.Recipients.accountNumber,
          ...
          scope.businessController.telebirrPayment(payload, scope.telebirrPaymentSuccess, scope.telebirrPaymentError);
        }
          ...
          scope.businessController.aTMPayment(payload, scope.aTMPaymentSuccess, scope.aTMPaymentError);
        }
        else{
    ...
    telebirrPaymentSuccess: function(response){
      ...
      UnifiedTransferConfirmStore.getState().Collection.transactionType = "TelebirrTransfer";
      UnifiedTransferConfirmStore.getState().Collection.TelebirrTransaction = response;
      this.setAcknowledgement();
    },
    aTMPaymentSuccess: function(response){
      response.transactionType = "ATMTransfer";
      // this.collectionObj.Collection = response;
      UnifiedTransferConfirmStore.getState().Collection.transactionType = "ATMTransfer";
      UnifiedTransferConfirmStore.getState().Collection.ATMTransaction = response;
      this.setAcknowledgement();
    },
    mpesaPaymentSuccess: function(response){
      response.transactionType = "MpesaTransfer";
      // this.collectionObj.Collection = response;
      UnifiedTransferConfirmStore.getState().Collection.transactionType = "MpesaTransfer";
      UnifiedTransferConfirmStore.getState().Collection.MpesaTransaction = response;
      this.setAcknowledgement();
    },
    mpesaTrustPaymentSuccess: function(response){
      response.transactionType = "MpesaTrustTransfer";
      // this.collectionObj.Collection = response;
      UnifiedTransferConfirmStore.getState().Collection.transactionType = "MpesaTrustTransfer";
      UnifiedTransferConfirmStore.getState().Collection.MpesaTrustTransaction = response;
      this.setAcknowledgement();
    },
    /**
     * @api : showCancelPopup
