define(['./ParserUtilsManager','./swiftLookupUtility','./SwiftLookUpDAO'],function(ParserUtilsManager,swiftLookupUtility,SwiftLookUpDAO) {
  ...
  getOnClick: function() {
    ...
    searchSwiftCode : function(){
      ...
      searchCriteria.bankName = this.view.txtBoxSearchField1.text;
      searchCriteria.branch = this.view.txtBoxSearchField2.text;
      searchCriteria.country = this.view.txtBoxSearchField3.text;
