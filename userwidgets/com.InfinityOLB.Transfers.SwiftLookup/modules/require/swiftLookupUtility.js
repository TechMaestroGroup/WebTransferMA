define(function () {
 ...
 /**
     ...
     */
    swiftLookupUtility.prototype.breakPointParser = function(inputJSON, lookUpKey) {
     ...
     */
    swiftLookupUtility.prototype.setFormattedData = function(formatValues, text, type) {
  ...
  */
    swiftLookupUtility.prototype.buttonParsedValue = function(property) {
      var parsedValue="";
      try{
  ...
  */
    swiftLookupUtility.prototype.retrieveEntitlement = function(property) {
      var parsedJson = "";
      var parsedValue = "";
      try{
     ...
     * @return : NA
     */
    swiftLookupUtility.prototype.readArray = function(array, jsonPath) {
     ...
     * @return : NA
     */
     swiftLookupUtility.prototype.readObject = function(obj, jsonPath) {
      ...
      swiftLookupUtility.prototype.isNullOrUndefinedOrEmpty = function(val){
