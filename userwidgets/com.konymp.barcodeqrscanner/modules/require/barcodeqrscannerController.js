    ...
    return {
        constructor: function(baseConfig, layoutConfig, pspConfig) {
            ...
            this.isCameaAdded = false;
              ...
              close : this.closeButtonVisibility,
              flash : this.flashButtonVisibility,
              camera : this.cameraToggleVisibility 
            };
            this.format = {
        ...
        scan: function(eventobject) {
            try {
                if (this._render && !this.isCameaAdded) {
                  	if(this.widgetVisibility.close)
                  		this.view.flxClose.isVisible = true;
                  	if(this.widgetVisibility.flash)
                    	this.view.flxFlash.isVisible = true;
                  	if(this.widgetVisibility.camera)
