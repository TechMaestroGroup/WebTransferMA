define(function () {
  ...
  /**
     ...
     */
  SavePayeeUtility.prototype.breakPointParser = function(inputJSON, lookUpKey) {
    try{
     ...
     */
    SavePayeeUtility.prototype.setFormattedData = function(formatValues, text, type) {
  ...
  */
    SavePayeeUtility.prototype.buttonParsedValue = function(property) {
    var parsedValue="";
    try{
  ...
  */
    SavePayeeUtility.prototype.retrieveEntitlement = function(property) {
    var parsedJson = "";
    var parsedValue = "";
    try{
     ...
     * @return : NA
     */
    SavePayeeUtility.prototype.readArray = function(array, jsonPath) {
     ...
     * @return : NA
     */
    SavePayeeUtility.prototype.readObject = function(obj, jsonPath) {
    ...
    SavePayeeUtility.prototype.isNullOrUndefinedOrEmpty = function(val){
