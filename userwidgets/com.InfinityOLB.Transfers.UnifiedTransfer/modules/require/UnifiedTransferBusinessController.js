define([
  ...
  BusinessController.prototype.getBankListName = function (onSuccess, onError) {
    var serviceName = "BOALocalServices";
    var integrationObj = KNYMobileFabric.getIntegrationService(serviceName);
    var operationName = "getBankLogoAndNameStubResponse";
    var params = {};
    var headers = {};
  ...
  BusinessController.prototype.fetchCombinedBankList = function (
    onSuccess,
    onError
  ) {
    var serviceName = "BOALocalServices";
    var integrationObj = KNYMobileFabric.getIntegrationService(serviceName);
    var operationName = "getAllOtherBanks";
    var data = {};
    var headers = {};
    integrationObj.invokeOperation(
      operationName,
