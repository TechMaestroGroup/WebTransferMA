define([
  "./UnifiedTransferStore",
  "./UnifiedTransferBusinessController",
  ...
  return {
    constructor: function (baseConfig, layoutConfig, pspConfig) {
      ...
      this.MIN_PAY_OTHER_VALUE =
        parseFloat(
          applicationManager.getConfigurationManager().minLoanPayOtherAmount
        ) || 1;
    ...
    preShow: function () {
      var scope = this;
      scope.businessController.getBankListName(
        scope.bankSuccess,
        scope.bankListError
      );
      scope.getBankList();
      try {
        scope.view.lblPayeeType1.text = "Own Account Transfer";
        scope.view.lblPayeeType2.text = "Within BOA";
        // scope.view.lblPayeeType2.left = "18dp";
        scope.view.lblPayeeTypeOption2.left = "10dp";
        scope.view.lblPayeeType2.left = "38dp";
        scope.view.flxPayeeType1.width = "190dp";
        if (scope.context.transferType === "Domestic Transfer") {
          scope.setPayeeField.bind("New Payee");
          scope.view.lblPayeeTypeOption2.text = "M";
          scope.view.lblPayeeTypeOption1.text = "L";
          scope.view.flxToKeyAndPayeeType.setVisibility(false);
        }
        this.view.tbxAccountNumber.secureTextEntry = false;
        this.view.flxPayeeAddressDetailHeader.setVisibility(false);
        ...
        if (scope.context.transferFlow === "") {
          this.view.segBankListDropdown.setData([]);
        }
        this.view.tbxPayeeName.placeholder = "";
        this.view.tbxPayeeName.text = "";
        this.view.tbxAccountNumber.secureTextEntry = false;
        if (this.context.transferType === "ATM Transfer") {
          this.view.tbxAccountNumber.placeholder =
            "Send Secret Code to my Phone Number:";
          this.view.lblAccountNumberKey.text =
            "Send Secret Code to my Phone Number";
          this.view.tbxAccountNumber.secureTextEntry = false;
          this.view.tbxPayeeName.placeholder = "";
          this.view.tbxPayeeName.text = "";
        }
        if (this.context.transferType === "MPESA Transfer") {
          this.view.tbxAccountNumber.placeholder = "Load to my Mobile";
          this.view.lblAccountNumberKey.text = "Enter Phone Number";
          this.view.tbxAccountNumber.secureTextEntry = false;
          this.view.tbxPayeeName.placeholder = "";
        ...
        if (this.context.transferType === "Telebirr Transfer") {
          this.view.tbxAccountNumber.placeholder = "Enter Phone Number";
          this.view.lblAccountNumberKey.text = "Enter Phone Number";
          this.view.tbxAccountNumber.secureTextEntry = false;
          this.view.tbxPayeeName.placeholder = "";
          // this.view.tbxAccountNumber.text = "";
        ...
        if (this.context.transferType === "MPESA Trust Transfer") {
          this.view.tbxAccountNumber.placeholder = "Agent Number";
          this.view.lblAccountNumberKey.text = "Enter Agent Phone Number";
          this.view.tbxAccountNumber.secureTextEntry = false;
          this.view.tbxPayeeName.placeholder = "";
          // this.view.tbxAccountNumber.text = "";
          // this.view.tbxPayeeName.text = "";
        ...
        if (scope.context.transferType === "Domestic Transfer") {
          scope.view.lblSelectedTransferCurrency.text = "Birr ETB";
          scope.view.flxTransferCurrencyDropdown.setEnabled(false);
          scope.setPayeeField.bind("New Payee");
        }
        this.view.flxAccountNumberField.setEnabled(true);
        this.view.tbxAccountNumber.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        this.view.tbxReEnterAccountNumber.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";

        this.view.flxPayeeField.setEnabled(true);
        for (i = 1; i <= 4; i++) {
          this.view["tbxPayeeDetail" + i].skin =
            "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        }

        this.view.flxTransferCurrency.setEnabled(true);
        this.view.flxTransferCurrencyDropdown.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";
        this.context.transferType === "Same Bank"
          ? this.view.flxTransferCurrencyDropdown.setEnabled(false)
          : this.view.flxTransferCurrencyDropdown.setEnabled(true);
        this.view.flxFXRateField.setEnabled(true);
        this.view.tbxFXRate.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        ...
        this.view.flxFrequencyDropdown.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";
        this.view.flxTransferDurationDropdown.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";

        this.view.flxStartDate.setEnabled(true);
        this.view.flxCalStartDate.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";

        this.view.flxRecurrences.setEnabled(true);
        this.view.tbxRecurrences.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        ...
        this.view.tbxIntermediaryBic.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        this.view.tbxE2EReference.skin =
          "ICSknTxtE3E3E3Border1px424242SSPRegular15px";

        this.view.flxPayeeAddressField.setEnabled(true);
        this.view.flxPayeeAddressDetailIcon.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";
        for (i = 1; i <= 8; i++) {
          if (i === 6 || i === 7) continue;
          this.view["tbxAddressField" + i].skin =
            "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        }
        ...
        this.view.flxAttachDocumentsIcon.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";

        //this.view.flxPayeeVerify.isVisible = false;
        this.view.flxVerifyInfo.isVisible = false;
        this.view.flxVerifyCheckbox.onClick =
          this.verifyCheckboxActions.bind(this);
        this.view.flxVerifyInfoIcon.onClick = this.showInfoPopup.bind(
          this,
          this.view.flxVerifyInfo
        );
        this.view.flxVerifyInfoCloseIcon.onClick = this.hideInfoPopup.bind(
          this,
          this.view.flxVerifyInfo
        );
    ...
    getBankList: function () {
      this.businessController.fetchCombinedBankList(
        this.combinedBankListSuccess,
        this.combinedBankListError
      );
    },

    combinedBankListSuccess: function (response) {
      console.log(JSON.stringify(response.body));
      this.bankListSuccess(response);
    },
    combinedBankListError: function (error) {
      alert(JSON.stringify(error));
    },

    bankSuccess: function (response) {
      this.bankSwiftCode = response;
    },
    getLatLong: function () {
      var scope = this;
    ...
    postShow: function () {
      var scope = this;
      try {
        scope.view.tbxAccountNumber.onEndEditing = function () {
          // if(scope.context.transferType === "MPESA Trust Transfer"){
          //   scope.verifyName();
          // }
          scope.resetTextBoxSkin(scope.view.tbxAccountNumber);
          scope.isAccountNumbersMatch(scope.view.tbxAccountNumber);
          if (scope.context.transferType === "Domestic Transfer") {
            scope.validateAccountNumberWithName(scope.view.tbxAccountNumber);
            scope.enableOrDisableContinueButton(true);
          } else {
            scope.processDataValidation(
              scope.view.tbxAccountNumber,
              "tbxAccountNumber"
            );
          }
        };
        this.businessController.invokeCustomVerbforGetAccountsAndPayees(
          scope.context.transferType
        );
        ...
        if (this.context.transferType === "Domestic Transfer") {
          ...
          this.setPayeeField.bind("New Payee");
        }
        ...
        if (
          scope.context.transferFlow !== "Modify" &&
          ...
          switch (scope.context.transferType) {
            ...
            case "Telebirr Transfer":
              serviceName = "TELEBIRR_TRANSFER_CREATE";
              break;
            case "ATM Transfer":
              serviceName = "ATM_TRANSFER_CREATE";
              break;
            case "AWACH Transfer":
              serviceName = "AWACH_TRANSFER_CREATE";
              break;
            case "MPESA Transfer":
              serviceName = "MPESA_TRANSFER_CREATE";
              break;
            case "MPESA Trust Transfer":
              serviceName = "MPESA_TRUST_TRANSFER_CREATE";
              break;
          }
        ...
        if (
          scope.context.transferFlow === "Repeat" ||
    ...
    setDefaultPayeeVerificationConfigs: function () {
      let currentLegalEntity = applicationManager
        .getUserPreferencesManager()
        .getCurrentLegalEntity();
      if (currentLegalEntity == null) {
        currentLegalEntity = applicationManager
          .getUserPreferencesManager()
          .getDefaultLegalEntity();
      }
      var verifyPayeeConfig =
        applicationManager.getConfigurationManager().verifyPayeeConfig;
      var entityConfigForVerifyPayee = verifyPayeeConfig.Entity;
      const entityConfigKey = entityConfigForVerifyPayee.find((obj) =>
        obj.hasOwnProperty(currentLegalEntity)
      );
      var entityConfigValue = entityConfigKey
        ? entityConfigKey[currentLegalEntity]
        : "";
      if (entityConfigValue === "Enabled") {
        let transferType;
        transferType = this.getVerifyPayeePaymentTypeConfigMap(
          this.context.transferType
        );
        if (
          transferType != "" &&
          ...
          let paymentTypeConfigForVerifyPayee =
            verifyPayeeConfig.PaymentType[transferType];
          let paymentTypeConfigValue =
            paymentTypeConfigForVerifyPayee.PayeeVerification;
          this.payeeVerification = paymentTypeConfigValue.toLowerCase();
          this.verifyPayeeConfigValueForSelectedPaymentType =
            paymentTypeConfigValue;
          try {
            switch (paymentTypeConfigValue.toLowerCase()) {
              case this.verifyPayeePaymentTypeConfigs.OPTIONAL:
                ...
                let countryCodeConfigValue =
                  paymentTypeConfigForVerifyPayee.CountryCodes;
                if (countryCodeConfigValue && countryCodeConfigValue.length > 0)
                  this.mandatoryCountryCodesList = Object.keys(
                    countryCodeConfigValue[0]
                  ).filter(
                    (key) =>
                      countryCodeConfigValue[0][key].toLowerCase() ===
                      "mandatory"
                  );
              ...
              case this.verifyPayeePaymentTypeConfigs.MANDATORY:
                ...
                if (this.view.lblPayeeTypeOption1.text === "M") {
                  this.view.flxVerifyCheckbox.setEnabled(true);
                  this.view.lblVerifyCheckbox.skin =
                    this.CHECKBOX_SELECTED_SKIN;
                  this.view.flxVerifyCheckbox.accessibilityConfig = {
                    a11yARIA: {
                      role: "checkbox",
                      "aria-labelledby": "lblVerifyPayeeTxt",
                  ...
                  this.view.lblVerifyCheckbox.skin =
                    this.CHECKBOX_SELECTED_DISABLED_SKIN;
                }
                break;
    ...
    setSegAccessibility: function (eventObject, eventPayload, context) {
      if (
        context.widgetInfo.rowTemplate === "flxAccountsDropdownList" ||
        context.widgetInfo.rowTemplate === "flxAccountsDropdownListMobile"
      ) {
        if (this.view.flxFromAccountSegment.isVisible === true) {
          this.view.flxFromTextBox.accessibilityConfig = {
            a11yARIA: {
        ...
        if (context.sectionIndex === context.widgetInfo.data.length - 1) {
          ...
          if (
            context.rowIndex ===
            context.widgetInfo.data[context.sectionIndex][1].length - 1
          ) {
            if (eventPayload.keyCode === 9 && !eventPayload.shiftKey) {
              if (this.view.flxFromAccountSegment.isVisible === true) {
                eventPayload.preventDefault();
        ...
        if (eventPayload.keyCode === 27) {
          ...
          if (this.view.flxTransferDurationList.isVisible == true) {
            this.toggleDropdownVisibility(
              this.view.flxTransferDurationDropdown,
              this.view.flxTransferDurationList,
              this.view.lblTransferDurationDropdownIcon,
              this.view.lblTransferDuration.id
            );
        ...
        if (eventPayload.keyCode == 9) {
          if (eventPayload.shiftKey) {
            if (context.rowIndex === 0) {
              ...
              context.rowIndex ===
              context.widgetInfo.data.length - 1
            ) {
              context.widgetInfo.rowTemplate = "ResourcesMA/flxListDropdown";
              if (this.view.flxTransferCurrencyList.isVisible == true) {
                eventPayload.preventDefault();
                context.widgetInfo.setActive(
                  rowIndex - 1,
                  secIndex,
                  "flxListDropdown"
                );
      ...
      if (eventPayload.keyCode === 27) {
        if (this.view.flxPayeeDetail5List.isVisible === true) {
          ...
          this.view.flxPayeeDetail5Dropdown.accessibilityConfig = {
            a11yLabel:
              this.view.lblPayeeDetail5.text +
              " " +
      ...
      if (eventPayload.keyCode === 27) {
        if (this.view.flxPurposeCodeList.isVisible === true) {
          ...
          this.view.flxPurposeCodeDropdown.accessibilityConfig = {
            a11yLabel:
              this.view.lblPurposeCode.text +
              " " +
              this.view.lblSelectedPurposeCode.text,
            a11yARIA: {
              "aria-expanded": false,
              role: "button",
            },
    ...
    onBreakPointChange: function () {
      ...
      if (breakpoint === 640) {
        ...
        this.view.rtxDueMessage.text =
          kony.i18n.getLocalizedString("i18n.loan.dueOn") +
          " " +
          dueDate +
          ": " +
          dueAmountRTX +
          "</br>" +
          kony.i18n.getLocalizedString("kony.mb.Loans.TotalOverdue") +
          ": " +
          totalOverDueRTX;
      } else {
        this.view.rtxDueMessage.text =
    ...
    setContext: function (context) {
      var scope = this;
      try {
        this.unsubscribe = UnifiedTransferStore.subscribe(
        ...
        if (
          ...
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["Transaction"]["errorDetails"]
          )
        ) {
    ...
    render: function () {
      ...
      try {
        ...
        if (
          ...
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection.Transaction["validateSuccess"]
          )
        ) {
          if (
            scope.collectionObj.Collection.Transaction["validateSuccess"] ===
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["bankDate"]
          )
        ) {
        ...
        if (
          scope.view.segFromAccounts.data.length == 0 &&
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["fromAccounts"]
          )
        ) {
        ...
        if (
          scope.view.segToAccounts.data.length == 0 &&
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["toAccounts"]
          )
        ) {
        ...
        if (
          scope.view.segBankClearingLookup.data.length == 0 &&
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["clearingCodeLookup"]
          )
        ) {
        ...
        if (
          scope.view.segLookupRecords.data.length == 0 &&
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["swiftCodeLookup"]
          )
        ) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["BankDetails"]
          )
        ) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["accountDetails"]
          )
        ) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["beneficiaryDetails"]
          )
        ) {
        ...
        if (
          scope.view.segFromAccounts.data.length != 0 &&
          (scope.transferFlow1 === "Repeat" || scope.transferFlow1 === "Edit")
        ) {
          scope.transferFlow1 = "";
        ...
        if (
          ...
          (scope.context !== undefined &&
            scope.context.transactionObject !== undefined &&
            scope.context.transactionObject.toAccountNumber !== undefined)
        ) {
          if (scope.allPayeesServiceCallFlag) {
            ...
            if (
              scope.context.transferFlow === "Repeat" ||
              scope.context.transferFlow === "Edit" ||
              scope.context.transferFlow === "PayBeneficiary"
            ) {
        ...
        if (
          scope.collectionObj.Collection["Transaction"]["payeeType"] ===
            "New Payee" &&
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["countries"]
          ) &&
          this.bankCountriesUpdated
        ) {
          this.bankCountriesUpdated = false;
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["beneficiaryCurrency"]
          )
        ) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["ibanError"]
          )
        ) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["purposeCodes"]
          ) &&
          this.purposeCodesUpdated
        ) {
          this.purposeCodesUpdated = false;
          this.setPurposeCodeDropdownValues(
            scope.collectionObj.Collection["purposeCodes"]
          );
        ...
        if (
          !scope.isEmptyNullOrUndefined(
            scope.collectionObj.Collection["clearingIdentifierCodes"]
          ) &&
          this.clearingIdentifierCodesUpdated
        ) {
          this.clearingIdentifierCodesUpdated = false;
          this.setClearingIdentifierDropdownValues(
            scope.collectionObj.Collection["clearingIdentifierCodes"]
          );
        ...
        if (
          ...
          !this.view.flxBankName.isVisible
        ) {
          scope.setBankNameForDomesticOrInternational();
        }
        if (
          scope.transferFlow2 === "PayBeneficiary" &&
          scope.context.transferType === "Domestic Transfer"
        ) {
          scope.transferFlow2 = "";
          scope.prefillAccountFields("To");
        }
    ...
    initComponentUI: function () {
      ...
      try {
        ...
        this.view.lblNoToRecordAction.setVisibility(false);
        this.setDropdownValues(
          this.view.segFrequencyList,
          scope.dataMapping["frequencies"],
          this.view.lblSelectedFrequency
        );
        this.setDropdownValues(
          this.view.segTransferDurationList,
          scope.dataMapping["transferDurations"],
          this.view.lblSelectedTransferDuration
        );
        // sammie
        ...
        if (scope.context.transferType === "International Transfer") {
          this.setCurrencyDropdownValues(
            this.view.segTransferCurrencyList,
            scope.dataMapping["currencies"]
          );
        ...
        //  }
        scope.view.flxPayeeType2.setVisibility(
    ...
    initActions: function () {
      var scope = this;
      try {
        this.view.flxPayeeTypeOption1.onClick = this.setPayeeField.bind(
          this,
          "Existing Payee"
        );
        this.view.flxPayeeTypeOption2.onClick = this.setPayeeField.bind(
          this,
          "New Payee"
        );
        this.view.flxNoToRecordAction.onClick = this.setPayeeField.bind(
          this,
          "New Payee"
        );
        this.view.flxPaymentMethodInfoIcon.onClick = this.showInfoPopup.bind(
          this,
          this.view.flxPaymentMethodInfo
        );
        this.view.flxFeesPaidByInfoIcon.onClick = this.showInfoPopup.bind(
          this,
          this.view.flxFeesPaidByInfo
        );
        this.view.btnSupprotingDocumentsInfoIcon.onClick =
          this.showInfoPopup.bind(this, this.view.flxSupportingDocumentsInfo);
        this.view.flxPaymentMethodInfoCloseIcon.onClick =
          this.hideInfoPopup.bind(this, this.view.flxPaymentMethodInfo);
        this.view.flxFeesPaidByCloseIcon.onClick = this.hideInfoPopup.bind(
          this,
          this.view.flxFeesPaidByInfo
        );
        scope.view.tbxAccountNumber.onEndEditing = function () {
        ...
        this.view.btnSupportingDocumentInfoCloseIcon.onClick =
          this.hideInfoPopup.bind(this, this.view.flxSupportingDocumentsInfo);
        this.view.flxPaymentTypeOption1.onClick =
          this.onPaymentAmountTypeSelect.bind(this, 1);
        this.view.flxPaymentTypeOption2.onClick =
          this.onPaymentAmountTypeSelect.bind(this, 2);
        this.view.flxPaymentTypeOption3.onClick =
          this.onPaymentAmountTypeSelect.bind(this, 3);
        this.view.flxPaymentTypeOption4.onClick =
          this.onPaymentAmountTypeSelect.bind(this, 4);
        this.view.flxPaymentMethodOption1.onClick =
          this.onPaymentMethodSelect.bind(this, 1);
        this.view.flxPaymentMethodOption2.onClick =
          this.onPaymentMethodSelect.bind(this, 2);
        this.view.flxPaymentMethodOption3.onClick =
          this.onPaymentMethodSelect.bind(this, 3);
        // this.view.flxPaymentMethodOption4.onClick = this.onPaymentMethodSelect.bind(this, 4);
        this.view.flxFeesPaidByOption1.onClick = this.onFeesPaidBySelect.bind(
          this,
          1
        );
        this.view.flxFeesPaidByOption2.onClick = this.onFeesPaidBySelect.bind(
          this,
          2
        );
        this.view.flxFeesPaidByOption3.onClick = this.onFeesPaidBySelect.bind(
          this,
          3
        );
        this.view.tbxIntermediaryBic.onKeyUp = this.setFormattedBicDetails.bind(
          this,
          "tbxIntermediaryBic"
        );
        ...
        this.view.segBankListDropdown.onRowClick =
          this.bankListSelection.bind(this);
        // if(this.context.transferType === "Telebirr Transfer"){
        //   this.view.tbxAccountNumber.onEndEditing = this.verifyName.bind(this);
        // }

        // ----
        this.view.flxTransferDurationDropdown.onClick =
          this.toggleDropdownVisibility.bind(
            this,
            this.view.flxTransferDurationDropdown,
            this.view.flxTransferDurationList,
            this.view.lblTransferDurationDropdownIcon,
        ...
        this.view.flxPayeeDetail5Dropdown.onClick =
          this.togglePayeeDetail5Dropdown;
        this.view.flxTransferCurrencyDropdown.onClick =
          this.toggleCurrencyDropdown;
        this.view.flxPurposeCodeDropdown.onClick =
          this.togglePurposeCodeDropdown;
        this.view.segFrequencyList.onRowClick =
          this.onFrequencySelection.bind(this);
        this.view.segTransferDurationList.onRowClick =
          this.onTransferDurationSelection.bind(this);
        this.view.segTransferCurrencyList.onRowClick =
          this.onCurrencySelection.bind(this);
        this.view.segPurposeCodeList.onRowClick =
          this.onPurposeCodeSelection.bind(this);
        this.view.segPayeeDetail5List.onRowClick =
          this.onPayeeDetail5Selection.bind(this);
        this.view.lblSelectedPayeeDetail5.text = kony.i18n.getLocalizedString(
          "i18n.payments.selectIdentifierCode"
        );
        this.view.flxPayeeAddressDetailIcon.onClick =
          this.togglePayeeAddressVisibility.bind(
            this,
            this.view.flxPayeeAddress,
            this.view.imgPayeeAddressDetailIcon
          );
        this.view.flxAttachDocumentsIcon.onClick =
          this.browseSupportingDocument.bind(this);
        this.view.lbxAddressField6.onSelection =
          this.updateStateList.bind(this);
        ...
        this.view.flxTransferCurrencyDropdown.onKeyPress =
          this.keyPressCurrency;
        this.view.flxFrequencyDropdown.onKeyPress = this.keyPressFrequency;
        this.view.flxTransferDurationDropdown.onKeyPress =
          this.keyPressTransferDuration;
        this.view.segFromAccounts.onRowClick =
          this.onFromAccountSelection.bind(this);
        this.view.segToAccounts.onRowClick =
          this.onToAccountSelection.bind(this);
        this.view.tbxFromAccount.onKeyUp = this.filterFromAccounts;
        this.view.tbxToAccount.onKeyUp = this.filterToAccounts;
        this.view.flxClearFromText.onClick = this.clearAccountTextboxTexts.bind(
          this,
          "From"
        );
        this.view.flxClearToText.onClick = this.clearAccountTextboxTexts.bind(
          this,
          "To"
        );
        if (
        ...
        this.view.flxLookUp2.onClick =
          this.showClearingCodeLookupPopup.bind(this);
        ...
        // sammie
        if (scope.context.transferType === "International Transfer") {
          this.view.tbxAccountNumber.onKeyUp =
            this.resetSwiftCodeFields.bind(this);
          // this.view.tbxReEnterAccountNumber.onKeyUp =
          //   this.resetSwiftCodeFields.bind(this);
          this.view.tbxPayeeDetail1.onKeyUp = this.setFormattedBicDetails.bind(
            this,
            "tbxPayeeDetail1"
          );
        } else {
        ...
        if (scope.context.transferType === "Pay a Person") {
          ...
          scope.view.flxTransferCurrencyDropdown.skin =
            "ICSknFlxffffffBordere3e3e31pxRadius3px";
        }

        if (
          this.context.transferFlow === "Edit" ||
          this.context.transferFlow === "EditModify"
        ) {
          ...
          this.view.tbxReEnterAccountNumber.skin =
            "ICSknTbxDisabledSSPreg42424215px";
          this.view.tbxReEnterAccountNumber.setVisibility(false);
          ...
          this.view.lbxAddressField6.skin =
            "ICSknLbxSSP42424215PxBordere3e3e3Disabled";
          this.view.lbxAddressField7.skin =
            "ICSknLbxSSP42424215PxBordere3e3e3Disabled";
          this.view.flxDocumentField.setEnabled(false);
          this.view.flxAttachDocumentsIcon.skin = "ICSknFlxDisabled";
        }
        this.view.flxPaymentMethodInfoCloseIcon.onKeyPress =
          this.toggleInfoPopupPayment;
        ...
        this.view.flxPaymentMethodInfoIcon.onKeyPress =
          this.toggleInfoPopupPayment;
        this.view.lblPaymentMethodInfoHeader.onKeyPress =
          this.toggleInfoPopupPayment;
        this.view.lblFeesPaidByInfoHeader.onKeyPress = this.toggleInfoPopupFees;
        this.view.flxPaymentType4InfoIcon.doLayout = function () {
          this.view.flxPaymentType4InfoIcon.info.frame =
            this.view.flxPaymentType4InfoIcon.frame;
        }.bind(this);
        this.view.flxPaymentType4InfoIcon.onClick = function () {
          this.view.flxPaymentTypeInfoPopup.left =
            -(
              this.view.flxPaymentType4InfoIcon.info.frame.x +
              this.view.flxPaymentType4InfoIcon.info.frame.width
            ) + "px";
        ...
        this.view.segRecentTransaction.onRowClick =
          this.segRecentTransactionClick;
      } catch (err) {
        var errorObj = {
          level: "ComponentController",
          method: "initActions",
    ...
    // sammienew
    onPayeeTypeSelection: function (widget) {
      var scope = this;
      try {
        var payeeType = widget.text === "M" ? "Existing Payee" : "New Payee";
        scope.businessController.storeInCollection({ payeeType: payeeType });

        if (scope.context.transferType === "Domestic Transfer") {
          // Force "New Payee" for Domestic Transfer
          // scope.view.lblPayeeTypeOption1.text = "N";
          // scope.view.lblPayeeTypeOption1.skin = scope.enabledRadioSkin;
          // scope.view.lblPayeeTypeOption2.text = "D";
          // scope.view.lblPayeeTypeOption2.skin = scope.disabledRadioSkin;
          scope.view.flxPayeeTypeOption2.setEnabled(false);
          ...
          scope.view.flxPayeeField.setVisibility(true);
          scope.view.flxAccountNumberField.setVisibility(true);
        } else if (
          scope.context.transferType === "Same Bank" &&
          payeeType === "Existing Payee"
        ) {
          // Refresh "To" accounts list to exclude "Recently Used" and "All Payees"
          scope.view.flxToAccountSegment.setVisibility(true);
          scope.view.tbxToAccount.setVisibility(true);
          scope.view.lblToRecordField1.setVisibility(false);
          scope.view.flxPayeeField.setVisibility(false);
          scope.view.flxAccountNumberField.setVisibility(false);
          scope.setToAccountsList();
        } else {
          // Handle New Payee for other transfer types
          scope.view.flxToAccountSegment.setVisibility(false);
          scope.view.tbxToAccount.setVisibility(true);
          scope.view.lblToRecordField1.setVisibility(false);
          scope.view.flxPayeeField.setVisibility(true);
        ...
        // Update accessibility for payee type options
        scope.view.flxPayeeTypeOption1.accessibilityConfig = {
          a11yARIA: {
            role: "radio",
            "aria-checked": payeeType === "Existing Payee",
            "aria-labelledby": "lblPayeeType1",
          },
        };
        scope.view.flxPayeeTypeOption2.accessibilityConfig = {
          a11yARIA: {
            role: "radio",
            "aria-checked": payeeType === "New Payee",
    ...
    verifyName: function () {
      this.view.tbxPayeeName.setVisibility(true);
      this.view.tbxPayeeName.text = "ALMAD SODIQ";
      this.view.tbxPayeeName.placeholder = "ALMAD SODIQ";
      this.view.tbxAccountNumber.secureTextEntry = false;
      this.businessController.storeInCollection({
        tbxPayeeName: this.view.tbxPayeeName.text,
        tbxAccountNumber: this.view.tbxAccountNumber.text,
        tbxAmount: this.view.tbxAmount.text,
        // "tbxFromAccount": this.view.lblRecordField1.text
      });
    ...
    setUIBasedOnTransferType: function () {
      ...
      try {
        if (
          this.context.transferType === "Same Bank" &&
          !this.context.isScheduleForm
        ) {
          scope.view.flxToKeyAndPayeeType.setVisibility(true);
          ...
          scope.view.flxToKeyAndPayeeType.setVisibility(true);
          this.view.flxPayeeType.setVisibility(true);
          kony.store.setItem("isScheduleFrm", this.context.isScheduleForm);
          this.view.flxPayeeField.setVisibility(false);
          this.view.flxPayeeAddressField.setVisibility(false);
          this.view.flxPaymentMethodField.setVisibility(false);
          this.view.flxFeesPaidByField.setVisibility(false);
          ...
          this.view.flxDateField.setVisibility(true);
          this.view.tbxAccountNumber.secureTextEntry = false;
          ...
          this.context.transferType === "Domestic Transfer" &&
          this.isScheduleForm
        ) {
          // sammie
          this.view.flxPayeeType.setVisibility(false);
          this.view.flxPayeeType1.setVisibility(false);
          this.view.lblPayeeTypeOption2.text = "M";
          ...
          this.view.lblE2EReference.left = "0%";
          this.view.tbxE2EReference.left = "0%";
        } else if (this.context.transferType === "Telebirr Transfer") {
          this.view.flxReEnterAccountNumber.setVisibility(false);
          this.view.flxToAccountField.setVisibility(false);
          this.view.flxBankListContainer.setVisibility(false);
          this.view.flxPayeeField.setVisibility(false);
          this.view.flxReEnterAccountNumber.setVisibility(false);
          this.view.flxPaymentAmountTypeField.setVisibility(false);
          this.view.flxFXRateField.setVisibility(false);
          this.view.flxPaymentMethodField.setVisibility(false);
          this.view.flxFrequencyField.setVisibility(false);
          this.view.flxDateField.setVisibility(false);
          this.view.flxFeesPaidByField.setVisibility(false);
          this.view.flxIntermediaryBicAndE2ERefField.setVisibility(false);
          this.view.flxNotesField.setVisibility(false);
          this.view.flxPayeeAddressField.setVisibility(false);
          this.view.flxDocumentField.setVisibility(false);
          ...
          this.view.lblSelectedTransferCurrency.setVisibility(true);
          this.view.lblSelectedTransferCurrency.text = "Birr ETB";
        } else if (this.context.transferType === "AWACH Transfer") {
          this.view.flxReEnterAccountNumber.setVisibility(false);
          this.view.flxToAccountField.setVisibility(false);
          this.view.flxBankListContainer.setVisibility(false);
          this.view.flxPayeeField.setVisibility(false);
          ...
          this.view.lblSelectedTransferCurrency.setVisibility(true);
          this.view.lblSelectedTransferCurrency.text = "Birr ETB";
        } else if (this.context.transferType === "MPESA Transfer") {
          this.view.flxReEnterAccountNumber.setVisibility(false);
          this.view.flxToAccountField.setVisibility(false);
          this.view.flxBankListContainer.setVisibility(false);
          this.view.flxPayeeField.setVisibility(false);
          ...
          this.view.lblSelectedTransferCurrency.setVisibility(true);
          this.view.lblSelectedTransferCurrency.text = "Birr ETB";
        } else if (this.context.transferType === "MPESA Trust Transfer") {
          this.view.flxReEnterAccountNumber.setVisibility(false);
          this.view.flxToAccountField.setVisibility(false);
          this.view.flxBankListContainer.setVisibility(false);
          this.view.flxPayeeField.setVisibility(false);
          ...
          this.view.lblSelectedTransferCurrency.setVisibility(true);
          this.view.lblSelectedTransferCurrency.text = "Birr ETB";
        } else if (this.context.transferType === "ATM Transfer") {
          this.view.tbxAccountNumber.placeholder =
            "Send Secret Code to my Phone Number:";
          this.view.lblAccountNumberKey.text =
            "Send Secret Code to my Phone Number";
          ...
          this.view.flxDocumentField.setVisibility(false);
          this.view.flxAccountNumberField.setVisibility(true);
          this.view.tbxPayeeName.setVisibility(false);
    ...
    setComponentUILabelText: function () {
      var scope = this;
      try {
        this.view.lblFromKey.text =
          this.businessController.getDataBasedOnDataMapping("lblFromKey") + ":";
        this.view.lblToKey.text =
          this.businessController.getDataBasedOnDataMapping("lblToKey") + ":";
        this.view.lblNoFromRecordMessage.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblNoFromRecordMessage"
          );
        this.view.lblNoFromRecordAction.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblNoFromRecordAction"
          );
        this.view.lblNoToRecordMessage.text = "No Account Found";
        // this.businessController.getDataBasedOnDataMapping(
        //   "lblNoToRecordMessage"
        // );
        // this.view.lblNoToRecordAction.text =
        //   this.businessController.getDataBasedOnDataMapping(
        //     "lblNoToRecordAction"
        //   );
        this.view.lblAccountNumberKey.text =
        ...
        this.view.lblReEnterAccountNumberKey.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblReEnterAccountNumberKey"
          ) + ":";
        this.view.lblPayeeDetail1.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail1") +
          ":";
        this.view.lblPayeeDetail2.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail2") +
          ":";
        this.view.lblPayeeDetail3.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail3") +
          ":";
        this.view.lblPayeeDetail4.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail4") +
          ":";
        this.view.lblPayeeDetail5.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail5") +
          ":";
        this.view.lblPayeeDetail6.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail6") +
          ":";
        this.view.lblPayeeDetail7.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail7") +
          ":";
        this.view.lblPayeeDetail8.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeDetail8") +
          ":";
        this.view.lblPayeeDetailWarning.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblPayeeDetailWarning"
          );
        this.view.lblTransferCurrency.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblTransferCurrency"
          ) + ":";
        this.view.lblAmount.text =
          this.businessController.getDataBasedOnDataMapping("lblAmount") + ":";
        this.view.lblFXRate.text =
          this.businessController.getDataBasedOnDataMapping("lblFXRate") + ":";
        this.view.lblPaymentMethod.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblPaymentMethod"
          ) + ":";
        this.view.lblFrequency.text =
          this.businessController.getDataBasedOnDataMapping("lblFrequency") +
          ":";
        this.view.lblTransferDuration.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblTransferDuration"
          );
        this.view.lblStartDate.text =
          this.businessController.getDataBasedOnDataMapping("lblStartDate") +
          ":";
        this.view.lblEndDate.text =
          this.businessController.getDataBasedOnDataMapping("lblEndDate") + ":";
        this.view.lblRecurrences.text =
          this.businessController.getDataBasedOnDataMapping("lblRecurrences") +
          ":";
        this.view.lblFeesPaidBy.text =
          this.businessController.getDataBasedOnDataMapping("lblFeesPaidBy") +
          ":";
        this.view.lblIntermediaryBic.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblIntermediaryBic"
          );
        this.view.lblE2EReference.text =
          this.businessController.getDataBasedOnDataMapping("lblE2EReference");
        this.view.lblPurposeCode.text =
          this.businessController.getDataBasedOnDataMapping("lblPurposeCode");
        this.view.lblSelectedPurposeCode.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSelectedPurposeCode"
          );
        this.view.lblNotes.text =
          this.businessController.getDataBasedOnDataMapping("lblNotes");
        this.view.lblAddressField1.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField1"
          ) + ":";
        this.view.lblAddressField2.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField2"
          ) + ":";
        this.view.lblAddressField3.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField3"
          ) + ":";
        this.view.lblAddressField4.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField4"
          ) + ":";
        this.view.lblAddressField5.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField5"
          ) + ":";
        //this.view.lblAddressField6.text = this.businessController.getDataBasedOnDataMapping("lblAddressField6") + ":";
        this.view.lblAddressField6.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField6"
          ) + ":";
        this.view.lblAddressField8.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblAddressField8"
          ) + ":";
        this.view.lblPayeeAddressDetail.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblPayeeAddressDetail"
          );
        this.view.lblSupportingDocuments.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocuments"
          );
        this.view.lblPayeeOptional.text =
          this.businessController.getDataBasedOnDataMapping("lblPayeeOptional");
        this.view.lblSupportingOptional.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingOptional"
          );
        this.view.lblLookupTitle.text =
          this.businessController.getDataBasedOnDataMapping("lblLookupTitle");
        this.view.lblLookupDescription.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblLookupDescription"
          );
        this.view.lblSearchField1.text =
          this.businessController.getDataBasedOnDataMapping("lblSearchField1") +
          ":";
        this.view.lblSearchField2.text =
          this.businessController.getDataBasedOnDataMapping("lblSearchField2") +
          ":";
        this.view.lblSearchField3.text =
          this.businessController.getDataBasedOnDataMapping("lblSearchField3") +
          ":";
        this.view.lblSearchField4.text =
          this.businessController.getDataBasedOnDataMapping("lblSearchField4") +
          ":";
        this.view.lblBankClearingLookupSearch1.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblBankClearingLookupSearch1"
          ) + ":";
        this.view.lblBankClearingLookupSearch2.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblBankClearingLookupSearch2"
          ) + ":";
        this.view.lblBankClearingLookupSearch3.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblBankClearingLookupSearch3"
          ) + ":";
        this.view.lblSupportingDocumentsInfoHeader.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocumentsInfoHeader"
          );
        this.view.lblSupportingDocumentInfo1.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocumentInfo1"
          );
        this.view.lblSupportingDocumentInfo2.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocumentInfo2"
          );
        this.view.lblSupportingDocumentInfo3.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocumentInfo3"
          );
        this.view.lblSupportingDocumentInfo4.text =
          this.businessController.getDataBasedOnDataMapping(
            "lblSupportingDocumentInfo4"
          );
      } catch (err) {
        var errorObj = {
          level: "ComponentController",
      ...
      try {
        ...
        this.view.lblFrequency.accessibilityConfig = {
          a11yLabel:
            this.view.lblFrequency.text +
            " " +
            this.view.lblSelectedFrequency.text,
          a11yARIA: {
            tabindex: -1,
          },
        };
        this.view.lblTransferCurrency.accessibilityConfig = {
          a11yLabel:
            this.view.lblTransferCurrency.text +
            " " +
            this.view.lblSelectedTransferCurrency.text,
          a11yARIA: {
            tabindex: -1,
          },
        };
        ...
        this.view.flxClearFromText.accessibilityConfig = {
          a11yLabel: "Clear From account",
          a11yARIA: { role: "button" },
        };
        ...
        this.view.tbxPayeeName.accessibilityConfig = {
          ...
          a11yLabel: this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeName",
            "placeHolder"
          ),
        };
        ...
        this.view.flxClearToText.accessibilityConfig = {
          a11yLabel: "Clear To account",
          a11yARIA: { role: "button" },
        };
        ...
        this.view.calStartDate.accessibilityConfig = {
          a11yARIA: {
            "aria-required": true,
            "aria-labelledby": "lblStartDate",
          },
        };
        this.view.calEndDate.accessibilityConfig = {
          a11yARIA: { "aria-required": true, "aria-labelledby": "lblEndDate" },
        };
    ...
    setComponentUITextboxPlaceholder: function () {
      var scope = this;
      try {
        this.view.tbxFromAccount.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxFromAccount",
            "placeHolder"
          );
        this.view.tbxToAccount.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxToAccount",
            "placeHolder"
          );
        ...
        this.view.tbxReEnterAccountNumber.placeholder =
          this.businessController.getDataBasedOnDataMapping(
        ...
        this.view.tbxPayeeDetail1.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail1",
            "placeHolder"
          );
        this.view.tbxPayeeDetail2.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail2",
            "placeHolder"
          );
        this.view.tbxPayeeDetail3.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail3",
            "placeHolder"
          );
        this.view.tbxPayeeDetail4.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail4",
            "placeHolder"
          );
        this.view.tbxPayeeDetail6.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail6",
            "placeHolder"
          );
        this.view.tbxPayeeDetail7.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPayeeDetail7",
            "placeHolder"
          );
        this.view.tbxAmount.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAmount",
            "placeHolder"
          );
        this.view.tbxPaymentAmount4.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxPaymentAmount4",
            "placeHolder"
          );
        this.view.tbxRecurrences.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxRecurrences",
            "placeHolder"
          );
        this.view.tbxIntermediaryBic.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxIntermediaryBic",
            "placeHolder"
          );
        this.view.tbxE2EReference.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxE2EReference",
            "placeHolder"
          );
        this.view.txtNotes.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "txtNotes",
            "placeHolder"
          );
        this.view.tbxAddressField1.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField1",
            "placeHolder"
          );
        this.view.tbxAddressField2.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField2",
            "placeHolder"
          );
        this.view.tbxAddressField3.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField3",
            "placeHolder"
          );
        this.view.tbxAddressField4.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField4",
            "placeHolder"
          );
        this.view.tbxAddressField5.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField5",
            "placeHolder"
          );
        this.view.tbxAddressField8.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxAddressField8",
            "placeHolder"
          );
        this.view.txtBoxSearchField1.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "txtBoxSearchField1",
            "placeHolder"
          );
        this.view.txtBoxSearchField2.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "txtBoxSearchField2",
            "placeHolder"
          );
        this.view.txtBoxSearchField3.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "txtBoxSearchField3",
            "placeHolder"
          );
        this.view.txtBoxSearchField4.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "txtBoxSearchField4",
            "placeHolder"
          );
        this.view.tbxBankClearingLookupSearch1.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxBankClearingLookupSearch1",
            "placeHolder"
          );
        this.view.tbxBankClearingLookupSearch2.placeholder =
          this.businessController.getDataBasedOnDataMapping(
            "tbxBankClearingLookupSearch2",
            "placeHolder"
          );
        this.view.tbxBankClearingLookupSearch3.placeholder =
          this.businessController.getDataBasedOnDataMapping(
    ...
    setComponentUIButtonTextAndTooltip: function () {
      var scope = this;
      try {
        scope.view.btn1.text =
          scope.businessController.getDataBasedOnDataMapping("btn1", "text");
        //scope.view.btn1.toolTip = scope.businessController.getDataBasedOnDataMapping("btn1", "toolTip");
        scope.view.btn2.text =
          scope.businessController.getDataBasedOnDataMapping("btn2", "text");
        // scope.view.btn2.toolTip = scope.businessController.getDataBasedOnDataMapping("btn2", "toolTip");
        scope.view.btnSearch.text =
          scope.businessController.getDataBasedOnDataMapping(
            "btnSearch",
            "text"
          );
        scope.view.btnSearch.toolTip =
          scope.businessController.getDataBasedOnDataMapping(
            "btnSearch",
            "toolTip"
          );
    ...
    bankListSuccess: function (response) {
      ...
      this.setBankListValues(
        this.view.segBankListDropdown,
        response,
        this.view.lblSelectedBank
      );
    },
    bankListError: function (response) {
      kony.application.dismissLoadingScreen();
      this.view.flxErrorMessage.setVisibility(true);
      this.view.rtxErrorMessage.text = "Error While Fetching Bank List";
    },
      ...
      try {
        ...
        if (response.body && Array.isArray(response.body)) {
          segmentData = response.body.map((bank) => ({
            key: bank.bicCode || null, // Bank code
            value: bank.institutionName, // Bank name
            bankId: bank.bankId || null,
          }));

          // Update selected label
          lblSelectedValue.text =
            segmentData.length > 0 ? "Select Bank" : "No Bank Selected";

          // Set widget data map and populate segment data
          seg.widgetDataMap = {
            lblListValue: "value", // Label for bank name
    ...
    setCurrencyDropdownValues: function (seg, listValues) {
      ...
      try {
        ...
        if (!scope.isEmptyNullOrUndefined(listValues)) {
          ...
          for (key in listValues) {
            var currSymbol = scope.businessController.getCurrencySymbol(
              listValues[key]
            );
            if (currSymbol === "ETB") {
              currSymbol = "Birr";
          ...
          seg.setData(segmentData);
          if (
            Object.keys(listValues).length === 1 &&
            scope.context.transferFlow !== "Repeat" &&
            scope.context.transferFlow !== "Edit"
          ) {
            ...
            scope.businessController.storeInCollection({
              transactionCurrency: segmentData[0].key,
            });
          }
        }
        this.view.lblTransferCurrency.accessibilityConfig = {
    ...
    setClearingIdentifierDropdownValues: function (clearingIdentifierCodes) {
      try {
        ...
        this.view.flxPayeeDetail5Dropdown.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";
        ...
        if (!this.isEmptyNullOrUndefined(clearingIdentifierCodes)) {
          ...
          if (
            clearingIdentifierCodes.length === 1 &&
            this.context.transferFlow !== "Repeat" &&
            this.context.transferFlow !== "Edit"
          ) {
    ...
    setPurposeCodeDropdownValues: function (purposeCodes) {
      try {
        ...
        this.view.flxPurposeCodeDropdown.skin =
          "ICSknFlxffffffBordere3e3e31pxRadius3px";
      ...
      try {
        if (payeeType === "Existing Payee") {
          ...
          for (i = 1; i <= 4; i++) {
            ...
            if (kony.application.getCurrentBreakpoint() === 640) {
              scope.view["tbxPayeeDetail" + i].skin =
                "ICSknTbxDisabledSSPreg42424213px";
            } else {
              scope.view["tbxPayeeDetail" + i].skin =
                "ICSknTbxDisabledSSPreg42424215px";
            }
          ...
          for (i = 1; i <= 8; i++) {
            ...
            if (kony.application.getCurrentBreakpoint() === 640) {
              scope.view["tbxAddressField" + i].skin =
                "ICSknTbxDisabledSSPreg42424213px";
            } else {
              scope.view["tbxAddressField" + i].skin =
                "ICSknTbxDisabledSSPreg42424215px";
          ...
          scope.view.lbxAddressField6.skin =
            "ICSknLbxSSP42424215PxBordere3e3e3Disabled";
          ...
          scope.view.flxPayeeDetail2.setVisibility(
            scope.context.transferType === "Pay a Person"
          );
          ...
          // sammie
          this.view.lblLookUp.setVisibility(
            scope.context.transferType === "International Transfer"
          );
          this.view.lblLookUp2.setVisibility(
            scope.context.transferType === "International Transfer"
          );
          this.view.flxLookUp.setVisibility(false);
          ...
          // sammie
          this.view.flxLookUp2.setVisibility(
            scope.context.transferType === "International Transfer"
          );
          if (kony.application.getCurrentBreakpoint() === 640) {
          ...
          for (i = 1; i <= 4; i++) {
            ...
            if (kony.application.getCurrentBreakpoint() === 640) {
              scope.view["tbxPayeeDetail" + i].skin =
                "ICSknTxtE3E3E3Border1pxRad2px424242SSPRegular13px";
            } else {
              scope.view["tbxPayeeDetail" + i].skin =
                "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
            }
        ...
        if (scope.context.transferType === "Domestic Transfer") {
          ...
          scope.view.tbxPayeeName.setEnabled(false);
        }
        if (scope.context.isScheduleForm) {
        ...
        scope.businessController.storeInCollection({
          ...
          tbxAccountNumber: "",
          tbxReEnterAccountNumber: tbxAccountNumber,
        });
    ...
    restrictSpecialCharacters: function () {
      ...
      try {
        ...
        if (this.context.transferType === "Same Bank") {
          this.view.tbxAccountNumber.restrictCharactersSet =
            specialCharactersSet + alphabetsSet + alphabetsSet.toUpperCase();
          this.view.tbxReEnterAccountNumber.restrictCharactersSet =
            specialCharactersSet + alphabetsSet + alphabetsSet.toUpperCase();
        } else {
          this.view.tbxAccountNumber.restrictCharactersSet =
            specialCharactersSet + space;
          this.view.tbxReEnterAccountNumber.restrictCharactersSet =
            specialCharactersSet + space;
        }
        if (this.context.transferType !== "Pay a Person") {
          this.view.tbxPayeeDetail1.restrictCharactersSet =
            specialCharactersSet;
        }
        this.view.tbxIntermediaryBic.restrictCharactersSet =
          specialCharactersSet;
    ...
    setBankDate: function () {
      ...
      try {
        if (
          !scope.isEmptyNullOrUndefined(this.bankDateObj.currentWorkingDate)
        ) {
          this.disableOldDaySelection(
            this.view.calStartDate,
            this.bankDateObj.currentWorkingDate
          );
          this.disableOldDaySelection(
            this.view.calEndDate,
            this.bankDateObj.currentWorkingDate
          );
        }
        if (scope.context.transferFlow !== "Edit") {
          const startDate =
            scope.businessController.getDateObjectFromCalendarString(
              scope.view.calStartDate.formattedDate,
              scope.view.calStartDate.dateFormat
            );
          scope.businessController.storeInCollection({
    ...
    disableOldDaySelection: function (calWidgetId, bankDate) {
      ...
      try {
        ...
        calWidgetId.enableRangeOfDates(
          [
            startDate.getDate(),
    ...
    showFrequencyDropdown: function () {
      ...
      this.updateTouchEndSubscriber("flxFrequencyList", {
    ...
    showBankListDropdown: function () {
      ...
      this.updateTouchEndSubscriber("flxBankDropdown", {
        shouldBeVisible: true,
      });
    ...
    showCurrencyDropdown: function () {
      ...
      this.updateTouchEndSubscriber("flxTransferCurrencyList", {
        shouldBeVisible: true,
      });
    ...
    onFrequencySelection: function () {
      ...
      try {
        ...
        if (selectedData["key"] === "Once") {
          ...
          this.view.lblStartDate.text =
            kony.i18n.getLocalizedString("i18n.transfers.send_on") + ":";
          scope.view.tbxRecurrences.text = "";
          if (
            !scope.isEmptyNullOrUndefined(this.bankDateObj) &&
            !scope.isEmptyNullOrUndefined(this.bankDateObj.currentWorkingDate)
          ) {
          ...
          scope.businessController.storeInCollection({
            ...
            isScheduled:
              scope.view.calStartDate.formattedDate !==
              scope.businessController.getFormattedDate(bankDate)
                ? "1"
                : "0",
          });
        } else {
          ...
          if (
            !scope.view.flxEndDate.isVisible &&
            !scope.view.flxRecurrences.isVisible
          ) {
            scope.view.lblSelectedTransferDuration.text =
              scope.view.segTransferDurationList.data[0]["value"];
            scope.view.lblStartDate.text =
              kony.i18n.getLocalizedString("i18n.transfers.start_date") + ":";
          ...
          var endDate =
            scope.businessController.getDateObjectFromCalendarString(
              scope.view.calEndDate.formattedDate,
              scope.view.calEndDate.dateFormat
            );
          scope.businessController.storeInCollection({
            frequencyType: selectedData["key"],
            frequencyEndDate: scope.view.flxEndDate.isVisible
              ? endDate.toISOString()
              : "",
            formattedEndOnDate: scope.view.flxEndDate.isVisible
              ? scope.view.calEndDate.formattedDate
              : "",
            tbxRecurrences: scope.view.flxRecurrences.isVisible
              ? scope.view.tbxRecurrences.text
              : "",
            isScheduled: "1",
          });
          ...
          this.view.lblTransferDuration.accessibilityConfig = {
            a11yLabel:
              this.view.lblTransferDuration.text +
              " " +
              this.view.lblSelectedTransferDuration.text,
            a11yARIA: {
              tabindex: -1,
            },
          };
    ...
    onTransferDurationSelection: function () {
      ...
      try {
        var selectedData =
          this.view.segTransferDurationList.selectedRowItems[0];
    ...
    showPurposeCodeDropdown: function () {
      ...
      this.updateTouchEndSubscriber("flxPurposeCodeList", {
        shouldBeVisible: true,
      });
    ...
    onPurposeCodeSelection: function () {
      try {
        ...
        if (selectedData.key === "0") {
          this.view.lblSelectedPurposeCode.text = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfers.SelectPurposeCode"
          );
          this.view.lblSelectedPurposeCode.skin = this.labelSkin;
          this.businessController.storeInCollection({
            purposeCode: "",
    ...
    showPayeeDetail5Dropdown: function () {
      ...
      this.updateTouchEndSubscriber("flxPayeeDetail5List", {
        shouldBeVisible: true,
      });
    ...
    onPayeeDetail5Selection: function () {
      try {
        ...
        if (selectedData.key === "0") {
          this.view.lblSelectedPayeeDetail5.text = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfer.selectClearingIdentifierCode"
          );
          this.view.lblSelectedPayeeDetail5.skin = this.labelSkin;
          this.businessController.storeInCollection({
          ...
          this.view.lblSelectedPayeeDetail5.text =
            selectedData["value"].length > 40
              ? selectedData["value"].substr(0, 39) + "..."
              : selectedData["value"];
          this.view.lblSelectedPayeeDetail5.skin = this.valueSkin;
          this.businessController.storeInCollection({
        ...
        this.view.flxPayeeDetail5Dropdown.setActive(true);
        if (
          this.view.tbxPayeeDetail1.text === "" &&
          this.verifyPayeeConfigValueForSelectedPaymentType === "Optional"
        ) {
          var countryCode = "";
          if (this.view.lblSelectedPayeeDetail5.text != "")
            countryCode = this.view.lblSelectedPayeeDetail5.text.substring(
              0,
              2
            );
    ...
    segRecentTransactionClick: function () {
      ...
      var swiftCode = data.swiftCode;
      var bankInfo = scope.bankSwiftCode[swiftCode];
      var bankName = bankInfo && bankInfo.name ? bankInfo.name : swiftCode;
      this.setPayeeField("New Payee");
      this.view.tbxAccountNumber.text = extractAccountNumber(
        data.toAccountNumber
      );
      this.selectedBankCode = data.swiftCode;
      this.view.lblSelectedBank.text = bankName;
      this.view.lblSelectedTransferCurrency.text = data.transactionCurrency;
      this.view.tbxAmount.text = formatAmount(data.amount);
      this.view.tbxPayeeName.text = data.beneficiaryName;
      // this.businessController.storeInCollection({
      //   tbxPayeeName: this.view.tbxPayeeName.text,
      //   tbxAccountNumber: this.view.tbxAccountNumber.text,
      //   tbxAmount: this.view.tbxAmount.text,
      ...
      if (
        ...
        if (selectedRecord.accountID === this.view.tbxAccountNumber.text) {
          this.disableButton();
          this.view.flxErrorMessage.setVisibility(true);
          this.view.rtxErrorMessage.text =
            "You cannot transfer to same account for own account transfer";
        } else {
          this.view.flxErrorMessage.setVisibility(false);
          this.enableOrDisableContinueButton(true);
        }
    ...
    onCurrencySelection: function () {
      ...
      try {
        let selectedData =
          this.view.segTransferCurrencyList.selectedRowItems[0];
        ...
        for (let i = 1; i <= 2; i++) {
          if (this.view["flxPaymentMethod" + i].isVisible) {
            if (i === idx) {
              ...
              this.view["lblPaymentMethodOption" + i].skin =
                this.enabledRadioSkin;
            } else {
              text = "lblPaymentMethod" + i;
              this.view["flxPaymentMethodOption" + i].accessibilityConfig = {
                a11yARIA: {
    ...
    updateServiceLevelProp: function () {
      try {
        ...
        let transactionCurrency =
          this.collectionObj.Collection.Transaction.transactionCurrency;
    ...
    updateNotesLengthIndicator: function () {
      ...
      this.view.lblNotesLength.accessibilityConfig = {
        a11yLabel:
          "Used " + this.view.txtNotes.text.length + " " + " of 140 characters",
        a11yARIA: {
          tabindex: -1,
          "aria-live": "polite",
        },
    ...
    validateBicDetails: function (tbxWidget) {
      ...
      try {
        ...
        if (value === "" && tbxWidget === "tbxPayeeDetail1") {
          ...
          scope.view.tbxPayeeDetail2.skin =
            "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        ...
        if (value) {
          ...
          if (isBicValid) {
            ...
            if (tbxWidget === "tbxIntermediaryBic") {
              scope.businessController.invokeCustomVerbforValidateIntermediaryBicCode(
                tbxWidget
              );
            } else {
            ...
            scope.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
        ...
        if (this.documentCount === scope.filesToBeUploaded.length) {
          if (files.length > 0) {
            ...
            if (
              ...
              scope.view.lblAttachDocumentError.text =
            ...
            if (files[0].file.size >= 2000000) {
              ...
              scope.filesToBeUploaded.length >= maxAttachmentsAllowed
            ) {
              scope.view.flxAttachDocumentError.setVisibility(true);
              scope.view.lblAttachDocumentError.text =
                kony.i18n.getLocalizedString(
              ...
              scope.view.lblAttachDocumentError.text =
                kony.i18n.getLocalizedString(
                  "i18n.TransfersEur.AttachmentFileNameErrorMsg1"
                );
              scope.view.forceLayout();
              return;
            } else {
              var fileData = {};
              scope.filesToBeUploaded.push([
                files[0].name,
                extension[extension.length - 1] === "pdf"
                  ? "pdf_image.png"
                  : "jpeg_image.png",
              ...
              scope.getBase64(files[0].file, function (base64String) {
                ...
                scope.businessController.storeAttachmentDataInCollection(
        ...
        for (var i = 0; i < scope.filesToBeUploaded.length; i++) {
          attachmentsData[i] = {
            ...
            removeAction: {
              ...
              accessibilityConfig: {
                a11yLabel:
                  "remove " + scope.filesToBeUploaded[i][0] + " document",
                a11yARIA: {
                  "aria-hidden": true,
                },
              },
    ...
    setCountryDataForPayeeDetails: function () {
      try {
        ...
        this.view.lbxPayeeDetail8.masterData =
          this.collectionObj.Collection.countries;
        if (selectedKey !== null) {
          this.view.lbxPayeeDetail8.selectedKey = selectedKey;
        } else {
          this.view.lbxPayeeDetail8.selectedKey =
            this.collectionObj.Collection.countries[0][0];
        }
      } catch (err) {
        var errorObj = {
          level: "ComponentController",
    ...
    setCountryAndStateMasterData: function () {
      ...
      try {
        if (scope.view.lbxAddressField6.selectedKey !== null) {
          scope.view.lbxAddressField6.selectedKey =
            scope.view.lbxAddressField6.selectedKeyValue[0];
        ...
        if (scope.view.lbxAddressField6.selectedKey === null) {
          scope.view.lbxAddressField6.masterData =
            scope.collectionObj.Collection.countries;
          scope.view.lbxAddressField6.selectedKey =
            scope.collectionObj.Collection.countries[0][0];
          //scope.view.lbxAddressField6.masterData = [["0", "Select a State"]];
          //scope.view.lbxAddressField6.selectedKey = scope.view.lbxAddressField6.masterData[0][0];
          //scope.view.lbxAddressField6.setEnabled(false);
        }
    ...
    selectState: function () {
      ...
      try {
        scope.businessController.storeInCollection({
          lbxAddressField6:
            scope.view.lbxAddressField6.selectedKeyValue[0] === "0"
              ? ""
              : scope.view.lbxAddressField6.selectedKeyValue[1],
        });
      } catch (err) {
        var errorObj = {
          level: "ComponentController",
      ...
      try {
        this.view.tbxFromAccount.onBeginEditing = function () {
          ...
          if (scope.fromKeyFromCall) {
            scope.updateTouchEndSubscriber("flxFromAccountSegment", {
              shouldBeVisible: false,
            });
            scope.updateTouchEndSubscriber("flxNoFromRecords", {
              shouldBeVisible: false,
            });
        ...
        this.view.tbxToAccount.onBeginEditing = function () {
          ...
          if (scope.fromKeyToCall) {
            scope.updateTouchEndSubscriber("flxToAccountSegment", {
              shouldBeVisible: false,
            });
            scope.updateTouchEndSubscriber("flxNoToRecords", {
              shouldBeVisible: false,
            });
        ...
        //   // sammie
        //   if(scope.view.lblPayeeTypeOption1.text === "M"){
        ...
        //   }
        //   if (scope.context.transferType === "Domestic Transfer") {
        //     var amount = parseFloat(scope.view.tbxAmount.text.replace(/[^0-9\.-]+/g, "")) || 0;
        //     if (amount > 0 && amount <= 100000) {
        //       scope.businessController.getAllETSwitchBankList(scope.bankListSuccess, scope.bankListError);
        //     } else if (amount > 100000) {
        //       if(selectedRecordTo.accountType === "External" || payeeType === "Existing Payee"){
        //         scope.view.lblSelectedBank.text = selectedRecordTo.bankName;

        //         scope.enableOrDisableContinueButton(true);
        //       }
        //       scope.businessController.getAllRTGSBankList(scope.bankListSuccess, scope.bankListError);
        //     }
        //     else {
        //       scope.view.lblSelectedBank.text = "";
        //       scope.view.flxBankListDropdown.setEnabled(false);
        //     }
        //     kony.application.dismissLoadingScreen();
        //   }
        ...
        this.view.tbxAmount.onEndEditing = function () {
          scope.view.tbxAmount.text =
            scope.businessController.getFormattedAmount(
              scope.view.tbxAmount.text
            );
          // if (scope.context.transferType === "Domestic Transfer") {
          //   // if (scope.view.lblPayeeTypeOption1.text === "M") {
          ...
          //   // else if (scope.view.lblSelectedBank.text !== "" || scope.view.lblSelectedBank.text !== "Select Bank") {
          //   //   scope.enableOrDisableContinueButton(true);
          //   // } else {
          //     // var amount =
          //     //   parseFloat(
          //     //     scope.view.tbxAmount.text.replace(/[^0-9\.-]+/g, "")
          //     //   ) || 0;
          //     // if (amount > 0 && amount <= 100000) {
          //     //   scope.businessController.getAllETSwitchBankList(
          //     //     scope.bankListSuccess,
          //     //     scope.bankListError
          //     //   );
          //     // } else if (amount > 100000) {
          //     //   scope.businessController.getAllRTGSBankList(
          //     //     scope.bankListSuccess,
          //     //     scope.bankListError
          //     //   );
          //     // } else {
        ...
        this.view.tbxPaymentAmount4.onEndEditing = function () {
          scope.resetTextBoxSkin(scope.view.tbxPaymentAmount4);
          scope.view.tbxPaymentAmount4.text =
            scope.businessController.getFormattedAmount(
              scope.view.tbxPaymentAmount4.text
            );
          scope.processDataValidation(
            scope.view.tbxPaymentAmount4,
            "tbxPaymentAmount4"
          );
          scope.validateLoanAmount(
            scope.businessController.getDeformattedAmount(
              scope.view.tbxPaymentAmount4.text
            )
          );
          scope.enableOrDisableContinueButton();
        ...
        this.view.tbxPayeeDetail1.onEndEditing = function () {
          ...
          if (scope.context.transferType !== "Pay a Person") {
            ...
            if (
              scope.verifyPayeeConfigValueForSelectedPaymentType === "Optional"
            ) {
              var countryCode = "";
        ...
        this.view.tbxPayeeDetail6.onEndEditing = function () {
          ...
          scope.businessController.storeInCollection({
            payeeBankStreet: scope.view.tbxPayeeDetail6.text,
          });
        ...
        this.view.tbxPayeeDetail7.onEndEditing = function () {
          ...
          scope.businessController.storeInCollection({
            payeeBankTown: scope.view.tbxPayeeDetail7.text,
          });
        ...
        this.view.tbxRecurrences.onEndEditing = function () {
          ...
          scope.businessController.storeInCollection({
            tbxRecurrences: scope.view.tbxRecurrences.text,
          });
        };
        ...
        this.view.calStartDate.onSelection = function () {
          ...
          if (
            !scope.isEmptyNullOrUndefined(scope.bankDateObj) &&
            !scope.isEmptyNullOrUndefined(scope.bankDateObj.currentWorkingDate)
          ) {
          ...
          const isScheduled =
            scope.collectionObj.Collection.Transaction.frequencyType !==
              "Once" ||
            scope.view.calStartDate.formattedDate !==
              scope.businessController.getFormattedDate(bankDate)
              ? "1"
        ...
        this.view.calEndDate.onSelection = function () {
          ...
          if (transactionObj.numberOfRecurrences !== "") {
            //Empty end date in payload if No.of recurrences selected
            scope.businessController.storeInCollection({
              frequencyEndDate: "",
              formattedEndOnDate: "",
            });
        ...
        this.view.tbxBankClearingLookupSearch1.onEndEditing = function () {
          ...
          scope.processDataValidation(
            form.tbxBankClearingLookupSearch1,
            "tbxBankClearingLookupSearch1"
          );
        };
        this.view.tbxBankClearingLookupSearch2.onEndEditing = function () {
          ...
          scope.processDataValidation(
            form.tbxBankClearingLookupSearch2,
            "tbxBankClearingLookupSearch2"
          );
        };
        this.view.tbxBankClearingLookupSearch3.onEndEditing = function () {
          ...
          scope.processDataValidation(
            form.tbxBankClearingLookupSearch3,
            "tbxBankClearingLookupSearch3"
          );
        };
      } catch (err) {
    ...
    // sammie
    teleBirrEnqSuccess: function (response) {
      kony.application.dismissLoadingScreen();
      // var name = response.body.Name + " " + response.body.FName + " " + response.body.GFName;
      var fullName =
        response.Name + " " + response.FName + " " + response.GFName;
      this.view.tbxPayeeName.setVisibility(true);
      this.view.tbxPayeeName.text = name || fullName;
      this.view.tbxPayeeName.placeholder = name || fullName;
      this.view.tbxAccountNumber.secureTextEntry = false;
      this.businessController.storeInCollection({
        tbxPayeeName: this.view.tbxPayeeName.text,
        tbxAccountNumber: this.view.tbxAccountNumber.text,
    ...
    teleBirrEnqError: function (response) {
      kony.application.dismissLoadingScreen();
      console.log(response.error.errMsg);
    },
    mpesaTrustEnqSuccess: function (response) {
      kony.application.dismissLoadingScreen();
      this.view.tbxPayeeName.setVisibility(true);
      this.view.tbxPayeeName.text = response.body[0].customerName;
      this.view.tbxPayeeName.placeholder = response.body[0].customerName;
      this.view.tbxAccountNumber.secureTextEntry = false;
      this.businessController.storeInCollection({
        tbxPayeeName: this.view.tbxPayeeName.text,
        tbxAccountNumber: this.view.tbxAccountNumber.text,
        tbxAmount: this.view.tbxAmount.text,
        paymentType: "MPESA Trust",
        // "tbxFromAccount": this.view.lblRecordField1.text
      });
      this.enableOrDisableContinueButton(true);
    },
    mpesaTrustEnqError: function () {
      kony.application.dismissLoadingScreen();
      console.log(response.error.errMsg);
    },
    mpesaEnqSuccess: function (response) {
      kony.application.dismissLoadingScreen();
      this.view.tbxPayeeName.setVisibility(true);
      this.view.tbxPayeeName.text = response.body[0].customerName;
      this.view.tbxPayeeName.placeholder = response.body[0].customerName;
    ...
    mpesaEnqError: function (response) {
      kony.application.dismissLoadingScreen();
      console.log(response.error.errMsg);
    },
    awachEnqSuccess: function (response) {
      kony.application.dismissLoadingScreen();
      this.view.tbxPayeeName.setVisibility(true);
      this.view.tbxPayeeName.text = response.body[0].customerName;
      this.view.tbxPayeeName.placeholder = response.body[0].customerName;
    ...
    awachEnqError: function () {
      kony.application.dismissLoadingScreen();
      console.log(response.error.errMsg);
    },
    //to get payeee name
    validateAccountNumberWithName: function (accountNumber) {
      var data = {
        accountNumber: accountNumber.text,
        bankToTransferTo: this.selectedBankId
          ? this.selectedBankId
          : this.selectedBankCode,
      };
      // this.enableOrDisableContinueButton(true);
      this.businessController.getAccountName(
        data,
        this.getAccountNameSuccess,
        this.getAccountNameFail
      );
    },
    ...
    getAccountNameSuccess: function (response) {
      kony.application.dismissLoadingScreen();
      // if(response.body[0])
      this.view.tbxPayeeName.text = response.body[0].beneficiaryName;
      this.view.tbxPayeeName.setEnabled(true);
      this.view.flxErrorMessage.setVisibility(false);
      this.businessController.storeInCollection({
        tbxPayeeName: this.view.tbxPayeeName.text,
        toAccountNumber: this.view.tbxAccountNumber.text,
        toAccountCurrency: "ETB",
        formattedToAccount: this.view.tbxAccountNumber.text,
        beneficiaryName: this.view.tbxPayeeName.text,
        beneficiaryBankName: this.view.lblSelectedBank.text,
        tbxAccountNumber: this.view.tbxAccountNumber.text,
        tbxReEnterAccountNumber: this.view.tbxAccountNumber.text,
      });
      this.validateTransaction();
    },
    validateTransaction: function () {
      var bankObj = this.selectedBankObj;
      var EtswitchEligiblity = bankObj.EtswitchEligiblity;
      var RtgsEligiblity = bankObj.RtgsEligiblity;
      var amount = parseInt(this.view.tbxAmount.text);

      if (amount <= 100000 && EtswitchEligiblity === "yes") {
        bankCode = bankObj.bankId;
        bankType = "ETHSwitch";
        this.enableOrDisableContinueButton(true);
      } else if (
        (amount > 100000 && RtgsEligiblity === "yes") ||
        (amount <= 100000 &&
          EtswitchEligiblity === "no" &&
          RtgsEligiblity === "yes")
      ) {
        bankCode = bankObj.bicCode;
        bankType = "RTGS";
        this.enableOrDisableContinueButton(true);
      } else if (amount > 100000 && RtgsEligiblity === "no") {
        scope.view.rtxErrorMessage.text =
          "Transfer amount exceeds the allowed amount for this bank.";
        return;
      }
    },
    ...
    getAccountNameFail: function (response) {
      ...
      // Check if response.body[0] is empty or does not exist
      if (!response.body || !response.body[0]) {
        scope.view.rtxErrorMessage.text =
          "Error: Missing or invalid response from the server.";
      } else {
        scope.view.rtxErrorMessage.text = "Invalid Account Number";
      }
      ...
      if (this.isLoanAccountSelected && this.loanAccountDetails !== undefined) {
        if (amount === "") {
          ...
          if (amount < parseFloat(this.loanAccountDetails.totalDueAmount)) {
            ...
            this.view.rtxAmountWarn.text = kony.i18n.getLocalizedString(
              "i18n.paydue.warning02"
            );
        ...
        if (
          this.loanErrors.has("LOAN_ERR_01") ||
          this.loanErrors.has("LOAN_ERR_02")
        ) {
    ...
    validateLoanDate: function (selectedDateObj) {
      if (this.isLoanAccountSelected && this.loanAccountDetails !== undefined) {
        if (selectedDateObj >= this.loanAccountDetails.dueDateObj) {
          ...
          this.view.rtxDateWarn.text = kony.i18n.getLocalizedString(
            "i18n.paydue.warning01"
          );
    ...
    processDataValidation: function (widgetScope, widgetName) {
      var scope = this;
      try {
        var mappedValueForWidget = scope.getMappedValueForWidget(
          widgetName,
          scope.dataMapping
        );
        var inputData = widgetScope.text;
        if (inputData) {
          scope.businessController.performDataValidation(
            inputData,
    ...
    setFlexFocusSkin: function (flxWidget) {
      flxWidget.skin =
        kony.application.getCurrentBreakpoint() === 640
          ? "ICSknFlxffffffBorder003e751pxRadius2px"
          : "ICSknFlxffffffBorder003e751pxRadius3px";
    },
    /**
    ...
    resetFlexFocusSkin: function (flxWidget) {
      flxWidget.skin =
        kony.application.getCurrentBreakpoint() === 640
          ? "ICSknFlxffffffBordere3e3e31pxRadius2px"
          : "ICSknFlxffffffBordere3e3e31pxRadius3px";
    },
    /**
    ...
    showFromAccountsDropdown: function () {
      try {
        ...
        if (segData.length != 0) {
          ...
          this.updateTouchEndSubscriber("flxFromAccountSegment", {
            shouldBeVisible: true,
          });
        } else {
          this.view.flxNoFromRecords.setVisibility(true);
          this.updateTouchEndSubscriber("flxNoFromRecords", {
            shouldBeVisible: true,
          });
        }
    ...
    showToAccountsDropdown: function () {
      try {
        ...
        if (segData.length != 0) {
          ...
          this.updateTouchEndSubscriber("flxToAccountSegment", {
            shouldBeVisible: true,
          });
        } else {
          this.view.flxNoToRecords.setVisibility(true);
          this.updateTouchEndSubscriber("flxNoToRecords", {
            shouldBeVisible: true,
          });
          this.view.flxToTextBox.accessibilityConfig = {
            a11yARIA: {
    ...
    toggleAccountsDropdown: function (fieldType) {
      ...
      try {
        ...
        if (
          !scope.view["flx" + fieldType + "AccountSegment"].isVisible &&
          !scope.view["flxNo" + fieldType + "Records"].isVisible
        ) {
    ...
    setFromAccountsList: function () {
      ...
      var scope = this;
      try {
        scope.setAccountsSegmentTemplateAndWidgetMap(
          scope.view.segFromAccounts
        );
        ...
        for (var i = 0; i < segData.length; i++) {
          ...
          segData[i]["lblRecordFieldTypeIcon1"] = {
            text:
              segData[i].isBusinessAccount === "true" ||
              segData[i].isBusinessPayee === "1"
                ? "r"
                : "s",
          };
          ...
          segData[i]["flxAccountsDropdownList"] = {
            accessibilityConfig: {
              a11yLabel:
                "Account Name" +
                " " +
                segData[i].lblRecordField1.text +
                " " +
                "Account Type" +
                " " +
                segData[i].lblRecordField3.text +
                " " +
                "Amount" +
                " " +
                segData[i].lblRecordField2.text,
              a11yARIA: {
                tabindex: 0,
                role: "button",
              },
          ...
          if (!this.isSingleCustomerProfile) {
            segData[i].lblRecordField4 = {
              isVisible: true,
              text: this.getTruncatedCustomerNameAndId(
                segData[i].MembershipName,
                segData[i].Membership_id
              ),
        ...
        if (!scope.isEmptyNullOrUndefined(scope.groupIdentifier)) {
          scope.groupedFromRecords = scope.prepareAccountsSegmentData(
            segData,
            "From"
          );
        } else {
    ...
    setToAccountsList: function () {
      ...
      try {
        ...
        for (var i = 0; i < segData.length; i++) {
          if (scope.context.transferType === "Same Bank") {
            segData[i]["lblRecordField3"]["isVisible"] =
              !segData[i]["isExternalAccount"];
            if (
              !this.isSingleCustomerProfile &&
              segData[i].accountType !== "CreditCard" &&
              !segData[i].isSameBankAccount
            ) {
              segData[i].lblRecordField4 = {
                isVisible: true,
                text: this.getTruncatedCustomerNameAndId(
          ...
          segData[i]["flxAccountsDropdownList"] = {
            accessibilityConfig: {
              a11yLabel:
                segData[i].lblRecordField2.text !== undefined &&
                segData[i].lblRecordField1.text !== undefined
                  ? "Account Name " +
                    segData[i].lblRecordField1.text +
                    " Account Type " +
                    segData[i].lblRecordField3.text +
                    " Amount " +
                    segData[i].lblRecordField2.text
                  : "Account Name " + segData[i].lblRecordField1.text + "",
              a11yARIA: {
                tabindex: 0,
                role: "button",
              },
          ...
          if (
            kony.application.getCurrentForm().id === "frmUTFDomesticTransfer" ||
        ...
        if (!scope.isEmptyNullOrUndefined(scope.groupIdentifier)) {
          scope.groupedToRecords = scope.prepareAccountsSegmentData(
            segData,
            "To"
          );
        } else {
    ...
    setSwiftLookUp: function () {
      ...
      try {
        if (kony.application.getCurrentBreakpoint() === 640) {
          ...
          this.view.segLookupRecords.rowTemplate =
            "ResourcesMA/flxLookupRecordList";
        ...
        for (var i = 0; i < segData.length; i++) {
          segData[i]["flxColumn3Value"] = {
            onClick: scope.getSwiftData.bind(
              scope.view.segLookupRecords.selectedRowItems
            ),
          };
    ...
    prepareAccountsSegmentData: function (recordsList, fieldType) {
      ...
      try {
        ...
        var types = [];
        if (fieldType === "From") {
          // types = this.moveToFirst(
          //   Object.keys(groupedRecordsList),
          //   "Favourite"
          // );
          types = this.moveToFirst(
            Object.keys(groupedRecordsList),
          ...
          // Conditon to move the Recently Used Accounts to the start of the list
          // types = this.moveToFirst(
          //   Object.keys(groupedRecordsList),
          //   "RecentlyUsed"
          // );
          ...
          types = Object.keys(groupedRecordsList).filter(function (key) {
            return (
              key !== "All Payees" &&
              key !== "default" &&
              key !== "RecentlyUsed"
        ...
        if (types.length != 0) {
          for (var i = 0; i < types.length; i++) {
            ...
            let headerDisplayText = !this.isSingleCustomerProfile
              ? this.getTruncatedHeaderText(displayText)
              : displayText;
            ...
            if (headerDisplayText === "Recently Used") {
              ...
              hearderText =
                headerDisplayText +
                " (" +
                groupedRecordsList[types[i]].length +
                ")";
            }
            data[i] = [
              {
                ...
                flxDropdownIcon: {
                  ...
                  onClick: scope.showOrHideAccountSection.bind(
                    scope,
                    fieldType
                  ),
                },
    ...
    groupAccountsData: function (data, fieldType) {
      ...
      try {
        ...
        var interalKey = !scope.isEmptyNullOrUndefined(internalContract)
          ? internalContract.identifier
          : undefined;

        var externalContract = this.groupIdentifier["external"];
        var externalKey = !scope.isEmptyNullOrUndefined(externalContract)
          ? externalContract.identifier
          : undefined;
          ...
          if (hasBuisnessAccounts) {
            return data.reduce(function (value, obj) {
              if (obj.isBusinessAccount === "true") {
                (value[obj["MembershipName"]] =
                  value[obj["MembershipName"]] || []).push(obj);
              } else if (
                obj.isBusinessAccount != null &&
                obj.isBusinessAccount !== ""
              ) {
                (value[obj["otherAccounts"]] =
                  value[obj["otherAccounts"]] || []).push(obj);
              } else {
                (value[obj["GroupField"]] =
                  value[obj["GroupField"]] || []).push(obj);
              }
              return value;
            }, {});
              ...
              if (obj.isExternalAccount == false) {
                ...
                if (obj.MembershipName) {
                  (value[obj["MembershipName"] + " - " + obj["Membership_id"]] =
                    value[
                      obj["MembershipName"] + " - " + obj["Membership_id"]
                    ] || []).push(obj);
                } else if (
                  !kony.sdk.isNullOrUndefined(interalKey) ||
                  interalKey === ""
                ) {
                  (value[obj[interalKey]] = value[obj[interalKey]] || []).push(
                    obj
                  );
                } else {
                  (value[obj["GroupField"]] =
                ...
                if (!scope.isEmptyNullOrUndefined(externalKey)) {
                  if (!externalKey.includes(",")) {
                    (value[obj[externalKey]] =
                      value[obj[externalKey]] || []).push(obj);
                  } else {
                    var identifierKey = externalKey.split(",");
                    for (var i = 0; i < identifierKey.length; i++) {
                      if (obj[identifierKey[i]]) {
                        (value[obj[identifierKey[i]]] =
                          value[obj[identifierKey[i]]] || []).push(obj);
                        break;
                      }
                    }
                  }
            ...
            return data.reduce(function (value, obj) {
              if (obj.isExternalAccount == false) {
                if (!scope.isEmptyNullOrUndefined(interalKey)) {
                  if (fieldType === "From" && obj.favouriteStatus === "1") {
                    (value["Favourite"] = value["Favourite"] || []).push(obj);
                  }
                  (value[obj[interalKey]] = value[obj[interalKey]] || []).push(
    ...
    onFromAccountSelection: function () {
      ...
      try {
        ...
        scope.view["tbxFromAccount"].text =
          selectedRecord.lblRecordField1.text || "";
        scope.view["lblFromRecordField1"].text =
          selectedRecord.lblRecordField1.text || "";
        if (
          scope.isLargeAccounts() &&
          selectedRecord &&
          selectedRecord.accountID
        ) {
          scope.getLatestBalance(
            selectedRecord.accountID,
            scope.view["lblAvailableBalanceValue"],
            scope.view["flxAvailableBalance"]
          );
        } else {
          scope.view["lblAvailableBalanceValue"].text =
            selectedRecord.lblRecordField2.text || "";
        ...
        if (
          scope.context.transferType !== "Pay a Person" ||
          kony.application.getCurrentForm().id === "frmUTFP2PTransfer"
        ) {
          scope.view.flxFromTextBox.setActive(true);
        }
        scope.businessController.storeSelectedAccountDataInCollection(
          selectedRecord,
          "From"
        );
        if (scope.context.transferType === "Same Bank") {
          scope.view.segToAccounts.removeAll();
          scope.businessController.filterAccountRecordsOnSelection(
            selectedRecord,
            scope.context.transferType,
            "From"
          );
        ...
        if (scope.context.transferType === "Pay a Person") {
          scope.view.lblSelectedCurrencySymbol.text =
            scope.businessController.getCurrencySymbol(
          ...
          scope.view.lblTransferCurrencyDropdownIcon.setVisibility(false);
          scope.businessController.storeInCollection({
            transactionCurrency: selectedRecord.currencyCode,
          });
        }
        scope.view.lblTransferCurrency.accessibilityConfig = {
          a11yLabel:
            scope.view.lblTransferCurrency.text +
            " " +
            scope.view.lblSelectedTransferCurrency.text,
          a11yARIA: {
            tabindex: -1,
    ...
    onToAccountSelection: function () {
      ...
      try {
        ...
        selectedRecordTo = selectedRecord;
        ...
        if (
          undefined !== selectedRecord.payeeVerification &&
          "Success" === selectedRecord.payeeVerification
        ) {
        ...
        if (selectedRecord.bankCountryName != "") {
          ...
          countryID = countriesList.find(
            (item) => item[1] === selectedRecord.bankCountryName
          );
        }
        scope.businessController.storeInCollection({
        ...
        if (scope.context.transferFlow !== "Edit") {
          ...
          if (scope.context.transferType === "Same Bank") {
            ...
            if (
              selectedRecord.accountType === "Savings" ||
              selectedRecord.accountType === "Checking"
            ) {
              scope.view.segFromAccounts.removeAll();
              scope.businessController.filterAccountRecordsOnSelection(
                selectedRecord,
    ...
    checkVerifyPayeeConfigForCountryCode: function (selectedRecord, countryID) {
      var countryCode = selectedRecord.swiftCode
        ? selectedRecord.swiftCode.substring(4, 6)
        : "";
      if (countryCode == "") {
        countryCode = selectedRecord.clearingIdentifierCode
          ? selectedRecord.clearingIdentifierCode.substring(0, 2)
          : countryID
          ? countryID[0]
          : "";
      }
    ...
    hideFromDropdown: function () {
      ...
      if (
        breakpoint === 640 &&
        this.view.flxAvailableBalance.isVisible === false
      ) {
    ...
    iconSeg: function (params) {
      if (params[2].sectionIndex === params[2].widgetInfo.data.length - 1) {
        if (
          params[2].widgetInfo.data[params[2].sectionIndex][0].lblDropdownIcon
            .text === "O"
        ) {
          if (this.view.flxFromAccountSegment.isVisible === true) {
    ...
    filterAccounts: function (fieldType) {
      ...
      try {
        ...
        var searchText =
          this.view["tbx" + fieldType + "Account"].text.toLowerCase();
        ...
        if (searchText != "") {
          ...
          let result = this.filterData(data, searchText, searchCriteria);
          if (!(result.length > 0)) {
            this.view["flx" + fieldType + "AccountSegment"].setVisibility(
              false
            );
            this.view["flxNo" + fieldType + "Records"].setVisibility(true);
          } else {
          ...
          this[fieldType + "searchApplied"] = false;
          this.view["seg" + fieldType + "Accounts"].removeAll();
          this.view["seg" + fieldType + "Accounts"].setData(
            this["grouped" + fieldType + "Records"]
          );
          this.view["flx" + fieldType + "AccountSegment"].setVisibility(true);
          this.view["flxNo" + fieldType + "Records"].setVisibility(false);
    ...
    validateData: function (dataValidator, widgetId) {
      ...
      try {
        ...
        if (
          !scope.isEmptyNullOrUndefined(scope.collectionObj.Collection.dvfError)
        ) {
        ...
        if (scope.isEmptyNullOrUndefined(dataValidator)) {
          if (scope.isNewAccountNumberValid && scope.isSwiftValid)
            scope.view.flxErrorMessage.setVisibility(false);
          if ("flxLookupErrorMessage" in form)
            form.flxLookupErrorMessage.setVisibility(false);
      ...
      try {
        ...
        for (var iterator in dvfError) {
          switch (iterator) {
            case "tbxPayeeName":
              scope.setErrorTextBoxSkin(scope.view.tbxPayeeName);
              txtField = kony.i18n.getLocalizedString(
                "i18n.StopCheckPayments.PayeeName"
              );
              break;
            ...
            case "tbxPayeeDetail1":
              ...
              txtField =
                scope.context.transferType === "Pay a Person"
                  ...
                  : kony.i18n.getLocalizedString("i18n.TransfersEur.BICSWIFT");
              if (scope.context.transferType !== "Pay a Person")
                scope.isSwiftValid = false;
              break;
            ...
            case "tbxE2EReference":
              ...
              txtField = kony.i18n.getLocalizedString(
                "i18n.UnifiedTransfer.E2EReference"
              );
              break;
        ...
        if (
          iterator === "txtBoxSearchField1" ||
          iterator === "txtBoxSearchField2" ||
          iterator === "txtBoxSearchField3" ||
          iterator === "txtBoxSearchField4"
        ) {
          form.rtxLookupErrorMessage.text = errorTxt;
          form.flxLookupErrorMessage.setVisibility(true);
        } else {
          if (
            iterator === "tbxAccountNumber" ||
            iterator === "tbxReEnterAccountNumber"
          ) {
    ...
    inValidIbanError: function () {
      this.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
        "i18n.UnifiedTransfer.InvalidIBANFormatMessage"
      );
     ...
     * @return : NA
     */
    isAccountNumbersMatch: function (tbx1Widget) {
      var scope = this;
      try {
        if (tbx1Widget.text !== "") {
          scope.isNewAccountNumberValid = true;
          if (scope.context.transferType === "Same Bank") {
            var isAccountNumberValid =
              scope.businessController.isValidAccountNumber(tbx1Widget.text);
            if (isAccountNumberValid) {
              var isExistingAccount =
                scope.businessController.checkExistingAccount(tbx1Widget.text);
              if (isExistingAccount) {
                scope.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
                  "i18n.UnifiedTransfer.AccountAlreadyExistMessage"
                );
                scope.view.rtxErrorMessage.accessibilityConfig = {
                  a11yARIA: {
                    tabindex: -1,
              ...
              scope.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
                "i18n.UnifiedTransfer.InvalidAccountNumberFormatMessage"
              );
              scope.view.rtxErrorMessage.accessibilityConfig = {
                a11yARIA: {
                  tabindex: -1,
            ...
            if (
              ...
              /^[a-z]{2}/i.test(tbx1Widget.text.slice(0, 2)) &&
              tbx1Widget.text.length < 35
            ) {
    ...
    setLoanView: function (selectedRecord) {
      try {
        ...
        const isPayOtherVisible =
          configMgr.checkUserPermission("PAY_OTHER_CREATE");
        ...
        var currencySymbol = this.businessController.getCurrencySymbol(
          selectedRecord["currencyCode"]
        );
        ...
        this.view.lblPaymentType1.text = kony.i18n.getLocalizedString(
          "i18n.Accounts.ContextualActions.payDueAmount"
        );
        this.view.lblPaymentType4.text = kony.i18n.getLocalizedString(
        ...
        this.businessController.storeInCollection({
          ...
          loanRepayOrderInitiationType:
            configMgr.getLoanRepayOrderInitiationType(),
        });
        this.enableOrDisableContinueButton();
      } catch (err) {
        var errorObj = {
    ...
    setCreditCardView: function (selectedRecord) {
      try {
        ...
        this.view.lblPaymentType1.text = kony.i18n.getLocalizedString(
          "i18n.unifiedTransfer.outstandingDue"
        );
        this.view.lblPaymentType4.text = kony.i18n.getLocalizedString(
          "i18n.UnifiedTransfers.OthersAmount"
        );
        ...
        this.view.lblPaymentAmount1.text =
          currencySymbol +
          this.businessController.getFormattedAmount(
            selectedRecord["outstandingBalance"]
          );
        this.view.lblPaymentAmount2.text =
          currencySymbol +
          this.businessController.getFormattedAmount(
            selectedRecord["paymentDue"]
          );
        this.view.lblPaymentAmount3.text =
          currencySymbol +
          this.businessController.getFormattedAmount(
            selectedRecord["minimumDue"]
          );
        this.view.lblPaymentAmount4Currency.text = currencySymbol;
        if (!this.isEmptyNullOrUndefined(selectedRecord["dueDate"])) {
          var dueDate = this.businessController.getFormattedDate(
            selectedRecord["dueDate"]
          );
          this.view.lblDueDate.text =
            "(" +
            kony.i18n.getLocalizedString("i18n.transfers.lblDate") +
            " " +
            dueDate +
            ")";
          this.view.flxEndDate.setVisibility(false);
    ...
    setCreditCardOrLoanView: function (selectedRecord) {
      ...
      try {
        var transactionCurrency = selectedRecord["currencyCode"];
        var currencySymbol = scope.businessController.getCurrencySymbol(
          selectedRecord["currencyCode"]
        );
        ...
        if (accountType === "Loan") {
          ...
          this.view.lblPaymentAmount3.text =
            currencySymbol +
            scope.businessController.getFormattedAmount(
              selectedRecord["currentAmountDue"]
            );
        } else {
          this.view.lblPaymentAmount1.text =
            currencySymbol +
        ...
        if (accountType == "CreditCard") {
          if (!scope.isEmptyNullOrUndefined(selectedRecord["dueDate"])) {
            var dueDate = scope.businessController.getFormattedDate(
              selectedRecord["dueDate"]
            );
            this.view.lblDueDate.text =
              "(" +
    ...
    setAccountDetailsResponse: function () {
      ...
      try {
        if (
          ...
          if (
            !scope.isEmptyNullOrUndefined(accDetails["nextPaymentDate"]) &&
            !this.isLoanAccountSelected
          ) {
            var dueDate = scope.businessController.getFormattedDate(
              accDetails["nextPaymentDate"]
            );
          ...
          if (this.isLoanAccountSelected) {
            ...
            const dueDate = this.businessController.getFormattedDate(
              accDetails["nextPaymentDate"]
            );
            ...
            this.loanAccountDetails.dueDateObj = new Date(
              accDetails["nextPaymentDate"]
            );
            let totalDueAmount =
              parseFloat(accDetails.nextPaymentAmount) +
              parseFloat(accDetails.paymentDue) +
              "";
            this.loanAccountDetails.totalDueAmount = totalDueAmount;
            const dueAmountRTX =
              "<b>" +
              this.view.lblPaymentAmount1.info.currencySymbol +
              this.businessController.getFormattedAmount(
                accDetails.nextPaymentAmount
              ) +
              "</b>";
            const totalOverDueRTX =
              "<b>" +
              this.view.lblPaymentAmount1.info.currencySymbol +
              this.businessController.getFormattedAmount(
                accDetails.paymentDue
              ) +
              "</b>";
            this.view.lblPaymentAmount1.text =
              this.view.lblPaymentAmount1.info.currencySymbol +
              this.businessController.getFormattedAmount(totalDueAmount);
    ...
    onPaymentAmountTypeSelect: function (idx) {
      ...
      try {
        ...
        if (idx === 4) {
          ...
          this.view.tbxPaymentAmount4.skin =
            "ICSknTxtE3E3E3Border1px424242SSPRegular15px";
        } else {
        ...
        var amount =
          idx !== 4
            ? scope.businessController.getFormattedAmount(
                scope.view["lblPaymentAmount" + idx].text
              )
            : "";
        scope.businessController.storeInCollection({
    ...
    setPayeeDetailFields: function (selectedRecord) {
      ...
      try {
        if (scope.context.transferType === "Domestic Transfer") {
          scope.selectedBankCode = selectedRecord.swiftCode || "";
          scope.view.lblSelectedBank.text = selectedRecord.bankName || "";

          scope.businessController.storeInCollection({
            swiftCode: scope.selectedBankCode,
            bankName: scope.view.lblSelectedBank.text,
          });
        }
        if (scope.context.transferType === "International Transfer") {
    ...
    setPayeeAddressDetailsFields: function (selectedRecord) {
      ...
      try {
        ...
        //scope.view.lbxAddressField6.selectedKey = scope.view.lbxAddressField6.masterData[0][0];
        scope.view.lbxAddressField6.masterData = selectedRecord.country
          ? [["0", selectedRecord.country]]
          : [["0", ""]];
        scope.view.lbxAddressField6.selectedKey =
          scope.view.lbxAddressField6.masterData[0][0];
    ...
    resetFrequencyFieldVisibility: function () {
      ...
      try {
        ...
        scope.businessController.storeInCollection({
          ...
          tbxRecurrences: "",
          isScheduled:
            this.view.calStartDate.formattedDate !==
            scope.businessController.getFormattedDate(bankDate)
              ? "1"
              : "0",
        });
        scope.view.lblFrequency.accessibilityConfig = {
          a11yLabel:
            scope.view.lblFrequency.text +
            " " +
            scope.view.lblSelectedFrequency.text,
          a11yARIA: { tabindex: -1 },
        };
      } catch (err) {
        var errorObj = {
    ...
    setBeneficiaryDetailsResponse: function () {
      ...
      try {
        if (
          ...
          scope.businessController.storeInCollection({
            tbxPayeeName: scope.view.tbxPayeeName.text,
          });
          if (
            scope.isEmptyNullOrUndefined(beneficiaryDetails.beneficiaryName)
          ) {
            scope.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
              "i18n.TransferEur.inValidAccountNumber"
            );
            scope.view.rtxErrorMessage.accessibilityConfig = {
              a11yARIA: {
                tabindex: -1,
    ...
    setConditionalMappingKey: function () {
      ...
      try {
        ...
        for (key in conditionalMappingKey) {
          ...
          conditionalMappingKey[key] = conditionalMappingKey[key][
            conditionalMappingKey[key].length - 1
          ].replace("}", "");
        }
        ...
        for (key in dataMapping) {
          if (key === "segments") {
            ...
            for (key in widgets) {
              if (segWidget === key) {
                var widgetId = key;
                var segData = scope.getSegmentDataFromMapping(
                  widgets[widgetId],
                  conditionalDataMapping[widgetId],
                  conditionalDataMappingKey[widgetId],
                  widgetId
                );
                return segData;
              }
     ...
     * @return : Array
     */
    getSegmentDataFromMapping: function (
      segDataJSON,
      conditionalMapping,
      conditionalMappingKey,
      segId
    ) {
      var scope = this;
      try {
        ...
        if (segMasterDataToken[0].indexOf("Collection") != -1) {
          ...
          segMasterData.map((record) => {
            ...
            for (key in segRecord) {
              segRecord[key] = {
                text: scope.getFieldValueFromMapping(
                  key,
                  segRecord[key],
                  conditionalMapping,
                  conditionalMappingKey,
     ...
     * @return : String
     */
    getFieldValueFromMapping: function (
      widget,
      fieldMapping,
      conditionalMapping,
      conditionalMappingKey,
      ...
      try {
        ...
        if (conditionalMappingKey) {
          if (conditionalMapping[record[conditionalMappingKey]] != undefined) {
            conditionalfieldMapping =
              conditionalMapping[record[conditionalMappingKey]][widget];
          }
        }
        ...
        if (typeof fieldMapping === "string") {
          if (fieldMapping.indexOf("$") !== -1) {
            if (fieldMapping.indexOf("${i18n") !== -1) {
              return kony.i18n.getLocalizedString(
                fieldMapping.substring(
                  fieldMapping.indexOf("${i18n{") + 7,
                  fieldMapping.length - 2
                )
              );
            } else {
          ...
          if (
            JSON.stringify(keys).indexOf("BP1") != -1 ||
            JSON.stringify(keys).indexOf("BP2") != -1 ||
            JSON.stringify(keys).indexOf("BP3") != -1
          ) {
            var fieldValue = this.getBreakpointBasedValue(
              fieldMapping,
              kony.application.getCurrentBreakpoint()
            );
            return this.getFieldValueFromMapping(
              widget,
              fieldValue,
              {},
              "",
            ...
            for (key in fieldMapping) {
              if (typeof fieldMapping[key] === "string") {
                if (fieldMapping[key].indexOf("${") !== -1) {
                  fieldMapping[key] = this.getFieldValueFromMapping(
                    widget,
                    fieldMapping[key],
                    {},
                    "",
    ...
    enableOrDisableContinueButton: function (isdvfValidated = true) {
      ...
      try {
        ...
        // if (transactionObj["transferType"] === "ATM Transfer") {
        //   var fromAccount = scope.view.tbxFromAccount.text;
        //   var toAccount = scope.view.tbxAccountNumber.text;
        //   var amount = scope.view.tbxAmount.text;

        //   if (
        //     !scope.isEmptyNullOrUndefined(fromAccount) &&
        //     !scope.isEmptyNullOrUndefined(toAccount) &&
        //     !scope.isEmptyNullOrUndefined(amount)
        //   ) {
        //     scope.enableButton(scope.view.btn2);
        //   } else {
        //     scope.disableButton(scope.view.btn2);
        ...
        // Ensure transactionCurrency is ETB for Domestic Transfers
        if (transactionObj["transferType"] === "Domestic Transfer") {
          transactionObj["transactionCurrency"] = "ETB"; // Enforce ETB for Domestic Transfers
          transactionObj["toAccountCurrency"] = "ETB";
          transactionObj["payeeType"] = "New Payee";
          collectionObj.Collection["Transaction"]["bankName"] =
            scope.view["lblSelectedBank"].text;
          collectionObj.Collection["Transaction"]["swiftCode"] =
            scope.selectedBankCode;

          collectionObj.Collection["Transaction"]["amount"] =
            scope.view.tbxAmount.text;
          collectionObj.Collection["Transaction"]["accountNumber"] =
            scope.view["tbxAccountNumber"].text;
          transactionObj["payeeName"] = scope.view.tbxPayeeName.text;
          transactionObj["amount"] = scope.view.tbxAmount.text;
          // transactionObj["swiftCode"] = scope.view.lblSelectedBank;

          if (
            !scope.isEmptyNullOrUndefined(scope.view["tbxAccountNumber"].text)
          ) {
            transactionObj["toAccountNumber"] =
              scope.view["tbxAccountNumber"].text;
          }
          if (transactionObj["payeeType"] === "External Payee") {
            if (
              typeof selectedRecord !== "undefined" &&
              selectedRecord !== null
            ) {
              transactionObj["payeeName"] = selectedRecordTo.payeeName;
              collectionObj.Collection["BankDetails"]["bankName"] =
                selectedRecord.bankName;
              collectionObj.Collection["BankDetails"]["swiftCode"] =
                selectedRecord["swiftCode"];
              transactionObj["toAccountNumber"] =
              ...
              if (
                scope.isEmptyNullOrUndefined(transactionObj["payeeName"]) ||
                scope.isEmptyNullOrUndefined(transactionObj["bankName"]) ||
                scope.isEmptyNullOrUndefined(transactionObj["swiftCode"]) ||
                scope.isEmptyNullOrUndefined(transactionObj["toAccountNumber"])
              ) {
                isdvfValidated = false;
              }
            } else {
        ...
        if (transactionObj["frequencyType"] !== "Once") {
          if (scope.view.flxEndDate.isVisible === true) {
            if (
              ...
              var startDate =
                scope.businessController.getDateObjectFromDateComponents(
              ...
              if (endDate.getTime() === startDate.getTime()) {
                this.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
                  "i18n.transfers.errors.sameEndDate"
                );
                scope.view.flxErrorMessage.setVisibility(true);
                isdvfValidated = false;
              } else if (endDate.getTime() < startDate.getTime()) {
                this.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
                  "i18n.transfers.errors.beforeEndDate"
                );
                scope.view.flxErrorMessage.setVisibility(true);
                isdvfValidated = false;
              }
          ...
          if (scope.view.flxRecurrences.isVisible === true) {
            if (
              scope.isEmptyNullOrUndefined(
                transactionObj["numberOfRecurrences"]
              )
            )
              isdvfValidated = false;
          }
        ...
        if (
          scope.view["tbxFromAccount"].text === "" ||
          scope.isEmptyNullOrUndefined(transactionObj["fromAccountNumber"])
        )
          isdvfValidated = false;
        ...
        if (transactionObj["payeeType"] === "Existing Payee") {
          if (scope.view["tbxToAccount"].text === "") isdvfValidated = false;
          if (
            transactionObj["transferType"] === "Pay a Person" &&
            scope.isEmptyNullOrUndefined(transactionObj["personId"])
          )
            isdvfValidated = false;
          if (
            transactionObj["transferType"] !== "Pay a Person" &&
          ...
          if (transactionObj["transferType"] === "Domestic Transfer") {
            if (
              scope.view.lblSelectedBank.text === "" ||
              scope.view.lblSelectedBank.text === "No Bank Selected"
            ) {
              isdvfValidated = false;
            }
          } else if (
          ...
          if (
            transactionObj["transferType"] !== "Domestic Transfer" &&
            !scope.isSwiftValid
          ) {
            isdvfValidated = false;
          }
        ...
        transactionObj["payeeName"] = scope.view.tbxPayeeName.text;
        transactionObj["amount"] = scope.view.tbxAmount.text;
        transactionObj["toAccountNumber"] = scope.view["tbxAccountNumber"].text;
        scope.businessController.storeInCollection({
          tbxPayeeName: scope.view.tbxPayeeName.text,
          tbxAccountNumber: scope.view.tbxAccountNumber.text,
        ...
        if (this.loanErrors.size > 0) {
          let errTextMap = {
            LOAN_ERR_01:
              kony.i18n.getLocalizedString("i18n.paydue.error01") +
              this.MIN_PAY_OTHER_VALUE,
            LOAN_ERR_02: kony.i18n.getLocalizedString("i18n.paydue.error02"),
            LOAN_ERR_03: kony.i18n.getLocalizedString("i18n.paydue.error03"),
          };
    ...
    validateIntNewPayeeBankDetails: function () {
      ...
      if (
        this.view.tbxPayeeDetail3.text !== "" &&
        !this.isEmptyNullOrUndefined(transactionObj.clearingIdentifierCode)
      ) {
        //bank's Clearing code with Clearing Identifier code is present
        return true;
      }
      if (
        this.view.tbxPayeeDetail2.text !== "" &&
        this.view.tbxPayeeDetail7.text !== "" &&
        this.view.lbxPayeeDetail8.selectedKey !== 0 &&
        this.view.lbxPayeeDetail8.selectedKey !== null &&
    ...
    showCancelPopup: function (flag, indexInfo) {
      ...
      try {
        ...
        if (flag === true) {
          ...
          customPopup.lblHeading.text = kony.i18n.getLocalizedString(
            "i18n.TransfersEur.RemoveAttachmentPopupHeading"
          );
          customPopup.lblPopupMessage.text = kony.i18n.getLocalizedString(
            "i18n.TransfersEur.RemoveAttachmentPopupMsg"
          );
        ...
        customPopup.flxCross.onClick = () => {
          ...
          if (this.rowId === null && this.sectionId === null) {
            ...
            scope.view.segDocumentList.setActive(
              this.rowId,
              this.sectionId,
              "flxDocumentsList.btnRemoveAttachment"
            );
            scope.rowId = null;
        ...
        customPopup.btnYes.onClick = () => {
          ...
          if (flag === true) {
            if (scope.context.isScheduleForm) {
              var param = "isScheduleForm";
              scope.onCancelTransfer(param);
            } else {
    ...
    showVerifyPayeeFailedPopup: function () {
      ...
      try {
        ...
        customPopup.lblHeading.text = kony.i18n.getLocalizedString(
          "i18n.UnifiedAddBeneficiary.UnVerifyLabel"
        );
        customPopup.lblHeading.accessibilityConfig = {
        ...
        var name =
          scope.collectionObj.Collection.Transaction["payeeVerificationName"];
        var errMsg =
          scope.collectionObj.Collection.Transaction["payeeVerificationErrMsg"];
        var verifyPayeeNameAutoUpdate = applicationManager
          .getConfigurationManager()
          .verifyPayeeNameAutoUpdate.toLowerCase();

        if (errMsg === "TimedOut") {
          customPopup.lblHeading.text = kony.i18n.getLocalizedString(
            "i18n.UnifiedAddBeneficiary.COPTimeOutHeader"
          );
        }
        customPopup.lblHeading.accessibilityConfig = {
        ...
        if (errMsg === "Account name does not match") {
          errMsg = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfers.errorCodes.ANNM"
          );
        } else if (errMsg === "Incorrect account number") {
          errMsg = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfers.errorCodes.AC01"
          );
        } else if (errMsg === "Opted out of CoP scheme") {
          errMsg = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfers.errorCodes.OPTO"
          );
        } else if (errMsg === "Account has been switched") {
          errMsg = kony.i18n.getLocalizedString(
            "i18n.UnifiedTransfers.errorCodes.CASS"
          );
        }
        ...
        if (this.view.lblPayeeTypeOption1.text === "M") {
          if (name) {
            customPopup.lblPopupMessage.text =
              errMsg +
              ". " +
              kony.i18n.getLocalizedString("i18n.userManagement.Name") +
              " " +
              name +
              ". ";
            customPopup.lblPopupMessage1.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedAddBeneficiary.COPDeleteExisting"
            );
          } else {
          ...
          if (name) {
            customPopup.lblPopupMessage.text =
              ...
              ". ";
            customPopup.lblPopupMessage1.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedAddBeneficiary.COPskip"
            );
          } else {
            customPopup.lblPopupMessage.text = errMsg + ". ";
            customPopup.lblPopupMessage1.text = kony.i18n.getLocalizedString(
        ...
        if (isPayeeMandatory) {
          if (
            ...
            customPopup.lblPopupMessage.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedAddBeneficiary.TimeOutForCOPMandatory"
            );
            customPopup.lblPopupMessage1.isVisible = false;
            customPopup.btnYes.text = kony.i18n.getLocalizedString(
              "i18n.transfers.Cancel"
            );
            customPopup.btnYes.accessibilityConfig = {
            ...
            customPopup.btnNo.text = kony.i18n.getLocalizedString(
              "i18n.qrpayments.Retry"
            );
            customPopup.btnYes.onClick = () => {
              flxPopupFlex.setVisibility(false);
              kony.application.getCurrentForm().remove(flxPopupFlex);
            ...
            if (this.view.lblPayeeTypeOption1.text === "M") {
              ...
              if (name) {
                customPopup.lblPopupMessage.text =
                  ...
                  name +
                  ". ";
                customPopup.lblPopupMessage1.text =
                  kony.i18n.getLocalizedString(
                    "i18n.UnifiedAddBeneficiary.COPDeleteExisting"
                  );
              } else {
              ...
              this.view.lblPayeeTypeOption1.text === "M" &&
              this.view["lblVerifiedPayee"].isVisible === true
            ) {
              customPopup.lblPopupMessage.text = kony.i18n.getLocalizedString(
                "i18n.UnifiedAddBeneficiary.COPSkipExisting"
              );
              customPopup.btnNo.text = kony.i18n.getLocalizedString(
                "i18n.transfers.Cancel"
              );
              ...
              customPopup.btnYes.text = kony.i18n.getLocalizedString(
                "i18n.UnifiedAddBeneficiary.COPskipBtn"
              );
              customPopup.btnYes.accessibilityConfig = {
              ...
              customPopup.btnYes.onClick = () => {
                ...
                this.view.lblVerifyCheckbox.text = this.CHECBOX_UNSELECTED;
                this.view.lblVerifyCheckbox.skin =
                  this.CHECKBOX_UNSELECTED_SKIN;
                this.validateInputDataAndCallAPI(this);
              };
            } else {
              customPopup.lblPopupMessage.text = kony.i18n.getLocalizedString(
                "i18n.UnifiedAddBeneficiary.COPCancel"
              );
              customPopup.btnNo.text = kony.i18n.getLocalizedString(
                "i18n.transfers.Cancel"
              );
              ...
              if (name) {
                ...
                if (verifyPayeeNameAutoUpdate === "enable") {
                  customPopup.lblPopupMessage1.text =
                    kony.i18n.getLocalizedString(
                      "i18n.UnifiedAddBeneficiary.COPNameUpdCancel"
                    );
                  customPopup.btnYes.text =
                    kony.i18n.getLocalizedString("i18n.wealth.accept");
                  customPopup.btnYes.accessibilityConfig = {
                    a11yLabel:
                      "Accept and correct payee name. You will be redirected to the transfers screen",
                    a11yARIA: {
                      tabindex: 0,
                      role: "button",
                    },
          ...
          if (
            ...
            customPopup.lblPopupMessage.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedAddBeneficiary.TimeoutForCOPOptional"
            );
            customPopup.lblPopupMessage1.isVisible = false;
            customPopup.btnYes.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedAddBeneficiary.COPskipBtn"
            ...
            if (this.view.lblPayeeTypeOption1.text === "M") {
              ...
              if (name) {
                ...
                if (verifyPayeeNameAutoUpdate === "enable") {
                  customPopup.lblPopupMessage1.text =
                    kony.i18n.getLocalizedString(
                      "i18n.UnifiedAddBeneficiary.COPNameUpdSkip"
                    );
                  customPopup.btnYes.text =
                    kony.i18n.getLocalizedString("i18n.wealth.accept");
                  customPopup.btnYes.accessibilityConfig = {
                    a11yLabel:
                      "Accept and correct payee name. You will be redirected to the add payee details screen",
                    a11yARIA: {
                      tabindex: 0,
                      role: "button",
                    },
                  ...
                  customPopup.lblPopupMessa.tge1ext =
                    kony.i18n.getLocalizedString(
                      "i18n.UnifiedAddBeneficiary.COPskip"
                    );
                }
    ...
    validateInputDataAndCallAPI: function () {
      try {
        if (
          this.context.transferType === "Telebirr Transfer" ||
          this.context.transferType === "ATM Transfer" ||
          this.context.transferType === "AWACH Transfer" ||
          this.context.transferType === "MPESA Transfer" ||
          this.context.transferType === "MPESA Trust Transfer"
        ) {
          // console.log("Telebirr Transfer: Using stored data instead of API validation.");
          var storedTransaction =
            UnifiedTransferStore.getState().Collection["Transaction"] || {};
      ...
      try {
        ...
        this.businessController.storeInCollection({
          verifyPayee: isPayeeChecked,
        });

        var paymentMethod =
          this.collectionObj.Collection["Transaction"]["paymentMethod"];
        var serviceLevelProprietary =
        ...
        var transactionObj = collectionObj.Collection["Transaction"];
        if (
          transactionObj["frequencyType"] !== "Once" &&
          transactionObj["formattedEndOnDate"] !== "Until I cancel"
        ) {
          if (
            !this.view.calStartDate.formattedDate ||
            !this.view.calEndDate.formattedDate
          ) {
            this.dateValidate();
            return;
          }
        ...
        if (
          ...
          this.businessController.invokeCustomVerbforValidateTransaction(
            this.context.transferType
          );
        }
      } catch (err) {
    ...
    prefillComponentData: function () {
      try {
        ...
        scope.view.tbxAmount.text = scope.businessController.getFormattedAmount(
          transObj.amount
        );
        if (scope.context.transferType === "Same Bank") {
          scope.view.lblSelectedCurrencySymbol.text =
            scope.businessController.getCurrencySymbol(
              transObj["transactionCurrency"]
            );
          scope.view.lblSelectedTransferCurrency.text =
            scope.view.lblSelectedCurrencySymbol.text +
            " " +
        ...
        scope.view.tbxIntermediaryBic.text =
          transObj["intermediaryBicCode"] || "";
        scope.view.tbxE2EReference.text = transObj["endToEndReference"] || "";
        var freqData = scope.view.segFrequencyList.data,
        ...
        var currData = scope.view.segTransferCurrencyList.data,
        ...
        for (let i = 0; i < currData.length; i++) {
          if (currData[i].key === transObj["transactionCurrency"]) {
            ...
            if (
              scope.context.transferType === "Domestic Transfer" &&
              !scope.isEmptyNullOrUndefined(transObj["paymentType"])
            ) {
              let paymentMethod =
                scope.dataMapping["paymentMethods"][currData[i].key];
        ...
        var feesPaidByIdx = transObj["chargeBearer"]
          ? transObj["chargeBearer"] === "OUR"
            ? 1
            : transObj["chargeBearer"] === "BEN"
            ? 2
            : 3
          : "";
        ...
        if (scope.context.transferFlow === "Edit") {
          ...
          const transferDurationKey = transObj["frequencyEndDate"]
            ? "ON_SPECIFIC_DATE"
            : "UNTIL_I_CANCEL";
          ...
          this.view.calStartDate.dateComponents = [
            frequencyStartDate.getDate(),
            frequencyStartDate.getMonth() + 1,
            frequencyStartDate.getFullYear(),
          ];
          if (transObj.frequencyEndDate) {
            const frequencyEndDate = new Date(transObj.frequencyEndDate);
            this.view.calEndDate.dateComponents = [
              frequencyEndDate.getDate(),
              frequencyEndDate.getMonth() + 1,
              frequencyEndDate.getFullYear(),
            ];
          }
          scope.onTransferDurationSelection();
        }
        if (scope.context.transferType !== "Same Bank" && isCurrencyAvailable)
          scope.onCurrencySelection();
        if (scope.view.flxFeesPaidByField.isVisible && feesPaidByIdx !== "")
          scope.onFeesPaidBySelect(feesPaidByIdx);
        if (
          scope.view.flxPaymentMethodField.isVisible &&
          paymentMethodIdx !== ""
        )
          scope.onPaymentMethodSelect(paymentMethodIdx);
        let dataToBeStored = {
          tbxAmount: scope.view.tbxAmount.text,
          transactionCurrency:
            scope.view.lblSelectedTransferCurrency.text !== ""
    ...
    prefillAccountFields: function (fieldType) {
      ...
      try {
        ...
        if (fieldType === "From") {
          var segData = scope.view.segFromAccounts.data,
            isFromAccountAvailable = false;
            ...
            for (let i = 0; i < segData.length; i++) {
              ...
              for (let j = 0; j < sectionRow.length; j++) {
                if (sectionRow[j].accountID === fromAccountNumber) {
                  ...
                  if (scope.context.transferFlow === "Edit")
                    scope.view.flxFromTextBox.setEnabled(false);
                  break;
                }
              }
            }
          ...
          var segData = scope.view.segToAccounts.data,
            isToAccountAvailable = false;
          var toAccountNumber =
            transObj["transactionType"] === "P2P"
              ? transObj.personId
              : transObj.toAccountNumber;
          if (!scope.isEmptyNullOrUndefined(scope.groupIdentifier)) {
            for (let i = 0; i < segData.length; i++) {
              var sectionRow = segData[i][1];
              for (let j = 0; j < sectionRow.length; j++) {
                if (
                  (transObj["transactionType"] === "ExternalTransfer" &&
                    sectionRow[j].accountNumber === toAccountNumber) ||
                  (transObj["transactionType"] === "InternalTransfer" &&
                    sectionRow[j].accountID === toAccountNumber) ||
                  (transObj["transactionType"] === "P2P" &&
                    sectionRow[j].PayPersonId === toAccountNumber)
                ) {
            ...
            for (let i = 0; i < segData.length; i++) {
              if (
                (transObj["transactionType"] === "ExternalTransfer" &&
                  segData[j].accountNumber === toAccountNumber) ||
                (transObj["transactionType"] === "InternalTransfer" &&
                  segData[j].accountID === toAccountNumber) ||
                (transObj["transactionType"] === "P2P" &&
                  sectionRow[j].PayPersonId === toAccountNumber)
              ) {
      ...
      try {
        ...
        var selectedRecord = {
          ...
          isInternationalAccount:
            transObj.serviceName ===
            "INTERNATIONAL_ACCOUNT_FUND_TRANSFER_CREATE"
              ? true
              : false,
          isSameBankAccount:
            transObj.serviceName === "INTRA_BANK_FUND_TRANSFER_CREATE"
              ? false
              : true,
          ...
          beneficiaryName:
            transObj.toAccountName ||
            transObj.beneficaryName ||
            transObj.beneficiaryName,
        ...
        if (scope.context.transferFlow !== "Edit") {
          ...
          if (scope.context.transferType === "Same Bank") {
            if (
              selectedRecord.accountType == "CreditCard" ||
              selectedRecord.accountType == "Loan"
            ) {
              // this.view.tbxAmount.text = "";
    ...
    showOrHideAccountSection: function (fieldType) {
      var scope = this;
      var sectionIndex =
        scope.view["seg" + fieldType + "Accounts"].selectedRowIndex[0];
      var segData = scope.view["seg" + fieldType + "Accounts"].data;
      ...
      var rowFlex =
        kony.application.getCurrentBreakpoint() === 640
          ? "flxAccountsDropdownListMobile"
          : "flxAccountsDropdownList";
      for (var i = 0; i < segData[sectionIndex][1].length; i++) {
        var rowDataTobeUpdated = JSON.parse(
          JSON.stringify(segData[sectionIndex][1][i][rowFlex])
        );
        rowDataTobeUpdated = {
      ...
      scope.view["seg" + fieldType + "Accounts"].setSectionAt(
        segData[sectionIndex],
        sectionIndex
      );
      scope.setAccountsDropdownHeight(fieldType);
      if (fieldType == "To") {
        scope.view.segToAccounts.setActive(
          -1,
          sectionIndex,
          "flxAccountsDropdownHeader.flxRecordType.flxDropdownIcon"
        );
        this.updateTouchEndSubscriber("flxToAccountSegment", {
          shouldBeVisible: true,
        });
      } else {
        scope.view.segFromAccounts.setActive(
          -1,
          sectionIndex,
          "flxAccountsDropdownHeader.flxRecordType.flxDropdownIcon"
        );
    ...
    updateKeyAt: function (widgetName, value, row, section, fieldType) {
      ...
      var rowDataTobeUpdated = JSON.parse(
        JSON.stringify(data[section][1][row])
      );
      rowDataTobeUpdated[widgetName] = value;
      scope.view["seg" + fieldType + "Accounts"].setDataAt(
        rowDataTobeUpdated,
        row,
        section
      );
      ...
      for (var i = 0; i < segData.length; i++) {
        if (i != 0) {
          ...
          for (var j = 0; j < segData[i][1].length; j++) {
            var rowDataTobeUpdated = JSON.parse(
              JSON.stringify(segData[i][1][j][rowFlex])
            );
            rowDataTobeUpdated = {
              height: "0dp",
              isVisible: false,
    ...
    setBankName: function (selectedRecord) {
      selectedRecord = !kony.sdk.isNullOrUndefined(selectedRecord)
        ? selectedRecord
        : this.view["segToAccounts"].selectedRowItems[0];
      if (this.context.transferType === "Same Bank") {
        if (
          selectedRecord &&
          selectedRecord.isSameBankAccount &&
          selectedRecord.payeeStatus
        ) {
          this.view["lblBankNameValue"].text = this.getTruncatedBankName(
            kony.i18n.getLocalizedString("i18n.UnifiedTransfer.BankName")
          );
          ...
          if (
            ...
            this.getLatestBalance(
              selectedRecord.accountID,
              this.view["lblBankNameValue"],
              this.view["flxBankName"]
            );
          } else {
            this.view["lblBankNameValue"].text =
              selectedRecord.lblRecordField2.text || "";
    ...
    showLookupPopup: function () {
      ...
      try {
        ...
        popupObj.flxLookupPopup.flxLookupTitle.flxLookupClose.btnLookupCloseIcon.onClick =
          function () {
    ...
    showClearingCodeLookupPopup: function () {
      ...
      try {
        ...
        popupObj.flxBankClearingPopup.flxBankClearingLookupTitle.flxBankClearingLookupClose.btnBankClearingLookupClose.onClick =
          function () {
            popupObj.isVisible = false;
            form.remove(popupObj);
    ...
    setClearingCodeLookupData: function () {
      ...
      if (
        form.segBankClearingLookup === undefined ||
        form.segBankClearingLookup === null
      ) {
        return;
      }
      try {
        if (kony.application.getCurrentBreakpoint() === 640) {
          ...
          form.segBankClearingLookup.rowTemplate =
            "ResourcesMA/flxLookupRecordList";
        ...
        var segData = this.getClearingCodeLookupSegData(
          "segBankClearingLookup"
        );
        for (var i = 0; i < segData.length; i++) {
          if (kony.application.getCurrentBreakpoint() === 640) {
            segData[i]["flxLookupRow"] = {
              onClick: scope.setClearingCodeData.bind(
                scope.view.segBankClearingLookup.selectedRowItems
              ),
            };
          } else {
            segData[i]["flxColumn3Value"] = {
        ...
        if (kony.application.getCurrentForm().segBankClearingLookup) {
          kony.application
            .getCurrentForm()
            .segBankClearingLookup.setData(segData);
        }
      } catch (err) {
        var errorObj = {
          level: "ComponentController",
    ...
    setClearingCodeData: function (scope, args) {
      ...
      var bankAddress = selectedRowItem.bankName
        ? selectedRowItem.bankName
        : "";
      var clearingCode = selectedRowItem.clearingCode
        ? selectedRowItem.clearingCode
        : "";
      this.view.tbxPayeeDetail2.text = bankAddress || "";
      // this.view.tbxPayeeDetail2.skin = "ICSknTbxDisabledSSPreg42424215px";
        ...
        clearingCodesLookup.forEach((code) => {
          ...
          rowData.lblLookupColumnValue3 = {
            text: kony.i18n.getLocalizedString(
              "i18n.UnifiedTransfer.selectCode"
            ),
          };
          rowData.flxColumn3Value = {
            onClick: this.setClearingCodeData.bind(
              this,
              this.view.segBankClearingLookup.selectedRowItems
            ),
          };
    ...
    setTransferCurrencyFieldFromAccounts: function (includeToAccounts) {
      ...
      var collectionObj = UnifiedTransferStore.getState();
      var transactionObj = collectionObj.Collection["Transaction"];
      var fromAccountCCY = scope.isEmptyNullOrUndefined(
        transactionObj["fromAccountCurrency"]
      )
        ? ""
        : transactionObj["fromAccountCurrency"];
      var toAccountCCY = scope.isEmptyNullOrUndefined(
        transactionObj["toAccountCurrency"]
      )
        ? ""
        : transactionObj["toAccountCurrency"];
      ...
      if (fromAccountCCY != toAccountCCY) {
        ...
        if (
          !scope.isEmptyNullOrUndefined(scope.serviceCurrency) &&
          fromAccountCCY != scope.serviceCurrency
        ) {
      ...
      if (scope.context.transferType === "Domestic Transfer") {
        var localCurrency = { ETB: "ETB" };
        scope.setCurrencyDropdownValues(
          this.view.segTransferCurrencyList,
          localCurrency
        );
      }
    ...
    setAccountsDropdownHeight: function (fieldType) {
      ...
      var breakPoint = kony.application.getCurrentBreakpoint();
      if (breakPoint === 640) {
        scope.view["flx" + fieldType + "AccountSegment"].height =
          totalHeight >= 572 ? "572dp" : totalHeight + "dp";
      } else if (breakPoint === 1024) {
        scope.view["flx" + fieldType + "AccountSegment"].height =
          totalHeight >= 520 ? "520dp" : totalHeight + "dp";
      } else {
        scope.view["flx" + fieldType + "AccountSegment"].height =
          totalHeight >= 546 ? "546dp" : totalHeight + "dp";
      }
    },
    /**
    ...
    verifyCheckboxActions: function () {
      ...
      this.view.lblVerifyCheckbox.text = isSelected
        ? this.CHECBOX_UNSELECTED
        : this.CHECBOX_SELECTED;
      this.view.lblVerifyCheckbox.skin = isSelected
        ? this.CHECKBOX_UNSELECTED_SKIN
        : this.CHECKBOX_SELECTED_SKIN;
      if (isSelected === false) {
        this.view.flxVerifyCheckbox.accessibilityConfig = {
    ...
    selectVerifyPayeeForMandatoryCountryCode: function (countryCode) {
      ...
      if (countryCode != "") {
        const isCountryMandatory = this.mandatoryCountryCodesList.some(
        ...
        if (isCountryMandatory) {
          if (
            ...
            this.view.lblVerifyCheckbox.text === this.CHECBOX_UNSELECTED &&
            this.view.lblPayeeTypeOption1.text !== "M" &&
            this.view.lblVerifiedPayee.isVisible === false
          ) {
            this.view.flxVerifyCheckbox.setEnabled(false);
            this.view.lblVerifyCheckbox.skin =
              this.CHECKBOX_SELECTED_DISABLED_SKIN;
    ...
    getTruncatedHeaderText: function (displayText) {
      let breakpoint = kony.application.getCurrentBreakpoint();
      let headerDisplayText = displayText.includes("-")
        ? displayText.split("-")
        : displayText;
      if (breakpoint === 640) {
        headerDisplayText =
          displayText.length > 30
            ? applicationManager
                .getPresentationUtility()
                .formatText(headerDisplayText[0], 24, headerDisplayText[1], 4)
            : displayText;
      } else {
        headerDisplayText =
          displayText.length > 50
            ? applicationManager
                .getPresentationUtility()
                .formatText(headerDisplayText[0], 44, headerDisplayText[1], 4)
            : displayText;
      }
    ...
    getTruncatedBankName: function (bankName) {
      ...
      if (breakpoint === 640) {
        bankName =
          bankName != "" && bankName.length > 30
            ? bankName.slice(0, 30) + "..."
            : bankName;
      } else {
        bankName =
          bankName != "" && bankName.length > 60
            ? bankName.slice(0, 60) + "..."
            : bankName;
      }
      return bankName;
    ...
    getLatestBalance: function (accountID, labelWidget, flxWidget) {
      ...
      accountManager.getLatestBalancesWithParams(
        params,
        getLatestBalancesSuccessCallback,
        getLatestBalanceserrorCallback
      );

      function getLatestBalancesSuccessCallback(successResponse) {
        if (
          successResponse &&
          successResponse.hasOwnProperty("Accounts") &&
          Array.isArray(successResponse.Accounts)
        ) {
          let accounts = successResponse.Accounts[0];
          let balance = accounts.currentBalance ? accounts.currentBalance : "";
          let currencyCode = accounts.currencyCode
            ? accounts.currencyCode
            : "ETB";
          let formatManager = applicationManager.getFormatUtilManager();
          let formattedAmount =
            currencyCode !== ""
              ? formatManager.formatAmountandAppendCurrencySymbol(
                  balance,
                  currencyCode
                )
              : formatManager.formatAmount(balance);
    ...
    getRecent: function () {
      ...
      try {
        ...
        if (scope.context.transferType === "Same Bank") {
          ...
          params = {
            TableName: "interbankfundtransfers",
          };
        } else {
          throw new Error(
            "Unsupported transfer type: " + scope.context.transferType
          );
        }

        scope.businessController.getRecent(
          params,
          scope.onSuccessHandler, // Reference the external success handler
          function (error) {
            console.error("Error during getRecent:", error);
            // Optionally delegate error to another handler too
          }
        );
      } catch (error) {
        console.error("Exception in getRecent:", error);
      }
    },
    onSuccessHandler: function (response) {
      var scope = this;
      console.log("Success inside handler:", response);
      ...
      function formatToDDMMYYYY(dateString) {
        ...
        // Extract date part
        let dateOnly = dateString.substring(0, 10); // e.g., "2025-05-26"
      ...
      var mappedTransactions = recentList.map((transactions) => ({
        lblAccountName: formatLongName(transactions.beneficiaryName),
        lblTransactionAmount: formatAmount(transactions.transactionAmount),
        lblTransactionDate: formatToDDMMYYYY(transactions.createdts),
    ...
    isLargeAccounts: function () {
      let accountCount = this.collectionObj.Collection.accountCount
        ? this.collectionObj.Collection.accountCount
        : 0;
