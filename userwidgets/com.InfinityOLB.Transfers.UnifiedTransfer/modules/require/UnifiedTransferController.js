  ...
  return {
    ...
    initComponentUI: function () {
      ...
      try {
        ...
        this.view.lblNoToRecordAction.setVisibility(
    ...
    setComponentUILabelText: function () {
      ...
      try {
        ...
        this.view.lblNoToRecordMessage.text =
          this.businessController.getDataBasedOnDataMapping(
    ...
    segRecentTransactionClick: function () {
      ...
      this.view.tbxAccountNumber.text = data.amount;
    ...
    performValidation: function () {
      ...
      try {
        ...
        this.view.tbxAccountNumber.onEndEditing = function () {
          ...
          //   scope.verifyName();
          // }
          if (scope.context.transferType === "ATM Transfer") {
            scope.businessController.storeInCollection({
            ...
            scope.enableOrDisableContinueButton(true);
          } else if (scope.context.transferType === "AWACH Transfer") {
            scope.businessController.getAwachCustomerName(
              scope.view.tbxAccountNumber.text,
              scope.awachEnqSuccess,
              scope.awachEnqError
            );
          } else if (scope.context.transferType === "MPESA Transfer") {
            scope.businessController.getMpesaCustomerName(
              scope.view.tbxAccountNumber.text,
              scope.mpesaEnqSuccess,
              scope.mpesaEnqError
            );
          } else if (scope.context.transferType === "MPESA Trust Transfer") {
            scope.businessController.getMpesaTrustCustomerName(
              scope.view.tbxAccountNumber.text,
              scope.mpesaTrustEnqSuccess,
              scope.mpesaTrustEnqError
            );
          } else if (scope.context.transferType === "Telebirr Transfer") {
            var now = new Date();
            var originatorConversationID = `${now.getFullYear()}${String(
              now.getMonth() + 1
            ...
            var payload = {
              account: scope.view.tbxAccountNumber.text,
              identifier: "932058484",
              SecurityCredential: "****************",
              OriginatorConversationID: originatorConversationID,
              Timestamp: parseInt(originatorConversationID, 10),
              Password: "*********************",
            };
            scope.businessController.getTelebirrCustomerName(
              payload,
              scope.teleBirrEnqSuccess,
              scope.teleBirrEnqError
            );
          } else {
              ...
              if (obj.isBusinessAccount == "true") {
                ...
                if (
                  !(
                    ...
                    obj.isBusinessAccount === undefined ||
            ...
            return data.reduce(function (value, obj) {
              if (obj.isExternalAccount == false) {
                ...
                if (fieldType === "To" && obj.isRecentlyUsed === "true") {
                  (value["RecentlyUsed"] = value["RecentlyUsed"] || []).push(
                    obj
                  );
                }
                  ...
                  if (!externalKey.includes(",")) {
                    ...
                    for (var i = 0; i < indentifierKey.length; i++) {
                      if (obj[indentifierKey[i]]) {
                        (value[obj[indentifierKey[i]]] =
                          value[obj[indentifierKey[i]]] || []).push(obj);
                        return value;
                      }
                    }
                  }
      ...
      try {
        if (tbx1Widget.text !== "" && tbx2Widget.text !== "") {
          ...
          if (tbx2Widget.text !== tbx1Widget.text) {
            scope.view.rtxErrorMessage.text = kony.i18n.getLocalizedString(
              "i18n.UnifiedTransfer.AccountNumberMismatchMessage"
            );
            scope.view.rtxErrorMessage.accessibilityConfig = {
              a11yARIA: {
                tabindex: -1,
            ...
            if (scope.context.transferType === "Same Bank") {
              ...
              if (isAccountNumberValid) {
                var isExistingAccount =
                  scope.businessController.checkExistingAccount(
                    tbx1Widget.text
                  );
    ...
    enableOrDisableContinueButton: function (isdvfValidated = true) {
      ...
      try {
        ...
        if (
          transactionObj["transferType"] === "Telebirr Transfer" ||
          transactionObj["transferType"] === "AWACH Transfer" ||
          transactionObj["transferType"] === "MPESA Transfer" ||
          transactionObj["transferType"] === "MPESA Trust Transfer"
        ) {
          var fromAccount = scope.view.tbxFromAccount.text;
          var toAccount = scope.view.tbxAccountNumber.text;
          var payeeName = scope.view.tbxPayeeName.text;
          var amount = scope.view.tbxAmount.text;

          if (
            !scope.isEmptyNullOrUndefined(fromAccount) &&
            !scope.isEmptyNullOrUndefined(toAccount) &&
            !scope.isEmptyNullOrUndefined(payeeName) &&
          ...
          return;
        } else if (transactionObj["transferType"] === "ATM Transfer") {
          var fromAccount = scope.view.tbxFromAccount.text;
          var toAccount = scope.view.tbxAccountNumber.text;
          var amount = scope.view.tbxAmount.text;
    ...
    onSuccessHandler: function (response) {
      ...
      var mappedTransactions = recentList.map((transactions) => ({
        ...
        lblTransactionAmount: transactions.transactionAmount,
