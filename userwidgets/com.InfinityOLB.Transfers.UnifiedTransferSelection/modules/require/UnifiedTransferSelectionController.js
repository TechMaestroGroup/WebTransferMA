define([
  "./UnifiedTransferSelectionBusinessController",
  "./UnifiedTransferSelectionStore",
  "CommonUtilities",
], function (
  BusinessController,
  UnifiedTransferSelectionStore,
  ...
  return {
    ...
    initActionsOfButtons: function () {
      ...
      this.view.btnAction1.onClick = this.buttonActionHandling.bind(
        this,
        "MakeTransfer"
      );
      this.view.btnAction2.onClick = this.buttonActionHandling.bind(
        this,
        "AddNewAccount"
      );
    ...
    bindFieldsData: function () {
      this.view.imgTransactionIcon.src =
        this.businessController.getDataBasedOnDataMapping(
          "imgTransactionIcon",
          this._dataMapping
        );
      this.view.lblTransactionType.text =
        this.businessController.getDataBasedOnDataMapping(
          "lblTransactionType",
          this._dataMapping
        );
      var descriptionText = this.businessController.getDataBasedOnDataMapping(
        "rtLearnMore",
        this._dataMapping
      );
      this.view.rtLearnMore.text = this.getShortDescription(descriptionText);
      var btn1Entitlement = this.businessController.isEntitled(
        this.businessController.getDataBasedOnDataMapping(
          "MakeTransfer",
          this._dataMapping
        )
      );
      var btn2Entitlement = this.businessController.isEntitled(
        this.businessController.getDataBasedOnDataMapping(
          "AddNewAccount",
          this._dataMapping
        )
    ...
    getShortDescription: function (description) {
      ...
      if (this.richTextId == "LearnMore1") {
        var moreLink =
          "<a id= " +
          this.richTextId +
          " aria-label='Learn more about within same bank transfer' tabindex = 0 role = button  href = " +
          "#>" +
          this.businessController.getDataBasedOnDataMapping(
            "MoreLink",
            this._dataMapping
        ...
        var moreLink =
          "<a id= " +
          this.richTextId +
          " aria-label='Learn more about domestic transfer' tabindex = 0 role = button  href = " +
          "#>" +
          this.businessController.getDataBasedOnDataMapping(
            "MoreLink",
            this._dataMapping
        ...
        var moreLink =
          "<a id= " +
          this.richTextId +
          " aria-label= 'Learn more about international transfer' tabindex = 0 role = button  href = " +
          "#>" +
          this.businessController.getDataBasedOnDataMapping(
            "MoreLink",
            this._dataMapping
        ...
        var moreLink =
          "<a id= " +
          this.richTextId +
          " aria-label='Learn more about pay a person' tabindex = 0 role = button   href = " +
          "#>" +
          this.businessController.getDataBasedOnDataMapping(
            "MoreLink",
            this._dataMapping
      ...
      var shortText =
        description.slice(0, descriptionRender) + "..." + moreLink;
      return shortText;
    },
    ...
    showDescription: function () {
      ...
      this.view.lblTransactionTypePopup.text =
        this.businessController.getDataBasedOnDataMapping(
          "lblTransactionTypePopup",
          this._dataMapping
        );
      this.view.rtPopupDescription.text =
        this.businessController.getDataBasedOnDataMapping(
          "rtPopupDescription",
          this._dataMapping
        );
      this.view.lblTermsConditionsTitle.text =
        this.businessController.getDataBasedOnDataMapping(
          "lblTermsConditionsTitle",
          this._dataMapping
        );
      this.view.rtTermsConditions.text =
        this.businessController.getDataBasedOnDataMapping(
          "rtTermsConditions",
          this._dataMapping
        );
    ...
    buttonActionHandling: function (clickedButton) {
      var selectedTransferType = {
        transferType: this.businessController.getDataBasedOnDataMapping(
          "transferType",
          this._dataMapping
        ),
