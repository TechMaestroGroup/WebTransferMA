  ...
  FormatUtils.prototype.formatText = function(value,type,FormatvalueJSON){
    ...
    if(fieldValue){
      if(fieldType == "amount"){
        ...
        //           var amount = parseInt(fieldValue);
...
//             scopeObj.view.lblEyeIcon.onTouchStart=scopeObj.maskunmaskAccountNumber;
...
//           else{
//             scopeObj.setTextToLabel(this._FieldValue);
//           }
//           if(this._accountNumberSkin && this._accountNumberSkin.skin){
