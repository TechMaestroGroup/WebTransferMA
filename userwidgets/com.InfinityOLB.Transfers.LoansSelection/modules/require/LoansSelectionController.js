define(['./UnifiedTransferSelectionBusinessController', './UnifiedTransferSelectionStore', 'CommonUtilities'], function (BusinessController, UnifiedTransferSelectionStore, CommonUtilities) {
  ...
  */
    ...
    //   else if(this.richTextId=="LearnMore5"){
    //       var moreLink = "<a id= " + this.richTextId + " aria-label= 'Learn more about tele-birr wallet' tabindex = 0 role = button  href = " + "#>" + this.businessController.getDataBasedOnDataMapping("MoreLink", this._dataMapping) + "</a>";

    //   }
      else
      {
          var moreLink = "<a id= " + this.richTextId + " aria-label='Learn more about local money transfer' tabindex = 0 role = button   href = " + "#>" + this.businessController.getDataBasedOnDataMapping("MoreLink", this._dataMapping) + "</a>";
      }
    ...
    //   lm4.tabIndex = -1;
    //   var lm5 = document.getElementById("LearnMore5");
    //   lm5.tabIndex = -1;
    },
    setRTIndex: function(){
      var lm1 = document.getElementById("LearnMore1");
