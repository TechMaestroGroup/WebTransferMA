 ...
 * @module frmMakeAwachPaymentController
 */
define([
  "CommonUtilities",
  "OLBConstants",
  ...
  return {
    ...
    initActions: function () {
      ...
      this.view.tbxAccountNumber.onEndEditing = function () {
        ...
        if (accountNumber.length < 11) {
          self.showFieldError(
            "Your digit must be at least 11, and all criteria must be met before entering the amount."
          );
        ...
        if (accountNumber.length > 11) {
          self.showFieldError(
            "Your digit must not exceed 11, and all criteria must be met before entering the amount."
          );
          self.view.txtAmount.setEnabled(false);
          self.view.tbxAccountNumber.setFocus(true);
          return;
        ...
        self.presenter.getAccountName(
          accountNumber,
          self.accountNameSuccess.bind(self),
          self.accountNameFailure.bind(self)
        );
      };
      ...
      this.view.btnConfirm.onClick = function () {
        this.presenter.showConfirmationPageAWACH();
    ...
    accountNameSuccess: function (response) {
    ...
    preShow: function () {
      ...
      var olbCons = JSON.parse(
        OLBConstants.CLIENT_PROPERTIES.TRANSFER_CREDIT_ACCT
      );
      var acctNumTo = olbCons.AWACH;
      this.selectedToAccount = {
        accountNumber: acctNumTo,
        accountID: acctNumTo,
        beneficiaryName: "AWACH ACCOUNT",
        beneficiaryNickname: "AWACH ACCOUNT",
        nickName: "AWACH ACCOUNT",
      };
      ...
      this.view.lblAccountName.text = "";
      this.view.lblTelebirrAccount.text = "To Account:";
    ...
    resetFormForOneTimePayment: function () {
      this.selectedToAccount = "";
      this.selectedToAccount.nickName = "AWACH ACCOUNT";
    ...
    submitTransfersForm: function () {
      if (this.validateData()) {
        ...
        if (isOwnAccountsFlow && data.toAccount.accountType === "CreditCard") {
          this.presenter.showConfirmationPageAWACH(data);
          // this.presenter.showConfirmation(data);
        } else {
          this.presenter.validateAWACHTransfers(data);
        }
      }
    },
    ...
    checkValidityMakeFastTransferForm: function () {
      ...
      if (!isOwnAccountsFlow) {
        ...
        if (
          ...
          formData.swiftCode.trim().length === 0
        ) {
          CommonUtilities.disableButton(this.view.btnConfirm);
          return;
        }
    ...
    selectToAccount: function (selectedAccount) {
      ...
      this.view.txtBeneficiaryNickName.text = "AWACH ACCOUNT";
      this.view.lblCount2.setVisibility(false);
    ...
    /** @alias module:frmMakeAwachPaymentController */
    ...
    updateFormUI: function (viewModel) {
      ...
      if (viewModel.validationSuccess) {
        ...
        this.presenter.confirmTransferDetailssAWACH(viewModel);
    ...
    populateBeneficiaryName: function (data) {
      ...
      if (data.beneficiaryName === "") {
        ...
        isInternationalAccount = "false";
        this.checkCurrency();
        data.beneficiaryName = "AWACH ACCOUNT";
        CommonUtilities.setText(
    ...
    preFillFromFormData: function (formDetails) {
      ...
      if (formDetails.oneTimePayment === true) {
        this.view.txtTransferTo.text = "AWACH ACCOUNT";
        this.view.txtBeneficiaryNickName.text = "AWACH ACCOUNT";
      }
    ...
    showToAccounts: function (accountTo) {
      ...
      if (isOwnAccountsFlow) {
        ...
        var filteredAccounts = toAccounts.filter(function (account) {
          ...
          var searchByNickName = account.nickName || "AWACH ACCOUNT";
          return (
            CommonUtilities.substituteforIncludeMethod(
    ...
    segRecentTransactionClick: function () {
      ...
      // this.view.lbxCurrency.selected = data.transactionCurrency;
    },
    ...
    getRecent: function () {
      ...
      var getRecentSuccess = function (response) {
        kony.print("Success inside handler: " + JSON.stringify(response));
