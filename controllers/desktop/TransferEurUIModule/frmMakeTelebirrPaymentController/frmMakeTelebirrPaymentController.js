  ...
  return {
    ...
    initActions: function () {
      ...
      this.view.btnConfirm.onClick = function () {
        this.presenter.showConfirmationPage();
    ...
    preShow: function () {
      ...
      var acctNumTo = olbCons.TELEBIR;
      this.selectedToAccount = {
        accountNumber: acctNumTo,
        accountID: acctNumTo,
        beneficiaryName: "TELEBIRR ACCOUNT",
        beneficiaryNickname: "TELEBIRR ACCOUNT",
    ...
    submitTransfersForm: function () {
      if (this.validateData()) {
        ...
        if (isOwnAccountsFlow && data.toAccount.accountType === "CreditCard") {
          this.presenter.showConfirmationPage(data);
          // this.presenter.showConfirmation(data);
        } else {
          this.presenter.validateTransfers(data);
        }
      }
    },
    ...
    updateFormUI: function (viewModel) {
      ...
      if (viewModel.validationSuccess) {
        ...
        this.presenter.confirmTransferDetailss(viewModel);
    ...
    getRecent: function () {
      ...
      var getRecentFailure = function (error) {
        kony.print("Error fetching transactions: " + JSON.stringify(error));
      };
