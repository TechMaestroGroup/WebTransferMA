 ...
 * @module frmMakeMpesaPaymentController
 */
define([
  "CommonUtilities",
  "OLBConstants",
  ...
  return {
    ...
    initActions: function () {
      ...
      this.view.btnConfirm.onClick = function () {
        this.presenter.showConfirmationPageMPESA();
    ...
    preShow: function () {
      ...
      var acctNumTo = olbCons.MPESA;
      this.selectedToAccount = {
        accountNumber: acctNumTo,
        accountID: acctNumTo,
        beneficiaryName: "MPESA ACCOUNT",
        beneficiaryNickname: "MPESA ACCOUNT",
        nickName: "MPESA ACCOUNT",
      };
      ...
      this.view.tbxAccountNumber.placeholder = "Phone Number";
      this.view.lblAccountName.text = "";
      this.view.lblTelebirrAccount.text = "Phone Number:";
    ...
    resetFormForOneTimePayment: function () {
      this.selectedToAccount = "";
      this.selectedToAccount.nickName = "MPESA ACCOUNT";
    ...
    submitTransfersForm: function () {
      if (this.validateData()) {
        ...
        if (isOwnAccountsFlow && data.toAccount.accountType === "CreditCard") {
          this.presenter.showConfirmationPageMPESA(data);
          // this.presenter.showConfirmation(data);
        } else {
          this.presenter.validateMPESATransfers(data);
        }
      }
    },
    ...
    selectToAccount: function (selectedAccount) {
      ...
      this.view.txtBeneficiaryNickName.text = "MPESA ACCOUNT";
      this.view.lblCount2.setVisibility(false);
    ...
    /** @alias module:frmMakeMpesaPaymentController */
    ...
    updateFormUI: function (viewModel) {
      ...
      if (viewModel.validationSuccess) {
        ...
        this.presenter.confirmTransferDetailssMPESA(viewModel);
    ...
    populateBeneficiaryName: function (data) {
      ...
      if (data.beneficiaryName === "") {
        ...
        isInternationalAccount = "false";
        this.checkCurrency();
        data.beneficiaryName = "MPESA ACCOUNT";
        CommonUtilities.setText(
    ...
    preFillFromFormData: function (formDetails) {
      ...
      if (formDetails.oneTimePayment === true) {
        this.view.txtTransferTo.text = "MPESA ACCOUNT";
        this.view.txtBeneficiaryNickName.text = "MPESA ACCOUNT";
      }
    ...
    showToAccounts: function (accountTo) {
      ...
      if (isOwnAccountsFlow) {
        ...
        var filteredAccounts = toAccounts.filter(function (account) {
          ...
          var searchByNickName = account.nickName || "MPESA ACCOUNT";
          return (
            CommonUtilities.substituteforIncludeMethod(
