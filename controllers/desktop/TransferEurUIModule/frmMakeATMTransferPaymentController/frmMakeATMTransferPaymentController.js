 ...
 * @module frmMakeATMTransferPaymentController
 */
define([
  "CommonUtilities",
  "OLBConstants",
  ...
  return {
    ...
    initActions: function () {
      ...
      this.view.btnConfirm.onClick = function () {
        this.presenter.showConfirmationPageATMTRAN();
    ...
    preShow: function () {
      ...
      var acctNumTo = olbCons.ATMTRAN;
      this.selectedToAccount = {
        accountNumber: acctNumTo,
        accountID: acctNumTo,
        beneficiaryName: "ATMTRAN ACCOUNT",
        beneficiaryNickname: "ATMTRAN ACCOUNT",
        nickName: "ATMTRAN ACCOUNT",
      };
      ...
      this.view.tbxAccountNumber.placeholder =
        "Phone Number to send Secret Code to: +251xxxxxxxx";
      this.view.lblAccountName.text = "";
      this.view.lblTelebirrAccount.text =
        "Phone Number to send Secret Code to:";
    ...
    resetFormForOneTimePayment: function () {
      this.selectedToAccount = "";
      this.selectedToAccount.nickName = "ATMTRAN ACCOUNT";
    ...
    submitTransfersForm: function () {
      if (this.validateData()) {
        ...
        if (isOwnAccountsFlow && data.toAccount.accountType === "CreditCard") {
          this.presenter.showConfirmationPageATM(data);
          // this.presenter.showConfirmation(data);
        } else {
          this.presenter.validateATMTransfers(data);
        }
      }
    },
    ...
    selectToAccount: function (selectedAccount) {
      ...
      this.view.txtBeneficiaryNickName.text = "ATMTRAN ACCOUNT";
      this.view.lblCount2.setVisibility(false);
    ...
    /** @alias module:frmMakeATMTRANPaymentController */
    ...
    updateFormUI: function (viewModel) {
      ...
      if (viewModel.validationSuccess) {
        ...
        this.presenter.confirmTransferDetailssATM(viewModel);
    ...
    populateBeneficiaryName: function (data) {
      ...
      if (data.beneficiaryName === "") {
        ...
        isInternationalAccount = "false";
        this.checkCurrency();
        data.beneficiaryName = "ATMTRAN ACCOUNT";
        CommonUtilities.setText(
    ...
    preFillFromFormData: function (formDetails) {
      ...
      if (formDetails.oneTimePayment === true) {
        this.view.txtTransferTo.text = "ATMTRAN ACCOUNT";
        this.view.txtBeneficiaryNickName.text = "ATMTRAN ACCOUNT";
      }
    ...
    showToAccounts: function (accountTo) {
      ...
      if (isOwnAccountsFlow) {
        ...
        var filteredAccounts = toAccounts.filter(function (account) {
          ...
          var searchByNickName = account.nickName || "ATMTRAN ACCOUNT";
          return (
            CommonUtilities.substituteforIncludeMethod(
