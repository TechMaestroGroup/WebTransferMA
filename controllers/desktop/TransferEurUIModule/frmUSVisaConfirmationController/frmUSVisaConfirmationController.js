define(['FormControllerUtility', 'CommonUtilities', 'ViewConstants', 'OLBConstants'], function(FormControllerUtility, CommonUtilities, ViewConstants, OLBConstants) {
    ...
    return {
        ...
        preShow: function() {
            ...
            this.view.lblAccountNumberKey.setVisibility(true);
        ...
        postShow: function() {
            ...
            this.view.lblAccountNumberKey.text = "amount" + ":" ;
            this.view.lblPaymentTypeKey.text =  "PIN" + ":" ;
            this.view.lblPaymentMethodKey.text =  "Expiry Date" + ":" ;
            this.view.lblSWIFTBICKey.text =  "Ordered By" + ":" ;
        ...
        getToAccountName: function(toAccount) {
            var accountName = toAccount.teleBirrAccountName || toAccount.nickName || toAccount.AccountName ;
            var nameToShow = "";
            if (accountName) {
                nameToShow = accountName + "...." + CommonUtilities.getLastFourDigit(toAccount.teleBirrAccount || toAccount.accountID);
            } else {
        ...
        confirmDetails: function(allData) {
            ...
            self.view.lblFromValue.text = data.fromAccount;
            self.view.lblBeneficiaryValue.text = data.passengerName;
            self.view.lblAccountNumberValue.text = data.amount;
            self.view.lblPaymentTypeValue.text = data.pin;
            self.view.lblPaymentMethodValue.text = data.expiryDate;
            self.view.lblSWIFTBICValue.text = data.orderedBy;
            ...
            // this.view.lblAccountNumberValue.text = data.toAccount.teleBirrAccount || data.toAccount.teleBirrAccount;
            ...
            //     FormControllerUtility.showProgressBar(this.view);
            //     if (data.isOwnAccount) {
            //         self.euroPresenter.showBillsPayScreen({
        ...
        showOwnAccountFields: function() {
            ...
            scopeObj.view.flxNewPayment.onClick = function() {
                scopeObj.euroPresenter.showTransferScreens({
                    context: "MakePaymentOwnAccounts"
                });
            };
            ...
            scopeObj.view.lblBeneficiaryKey.text = "Passenger's Name" + ":" ;
