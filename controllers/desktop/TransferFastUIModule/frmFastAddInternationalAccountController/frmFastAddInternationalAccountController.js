    ...
    return {
        init: function () {
            ...
            scopeObj.view.btnAddAccountKA.onClick = function () {
                if (combineduser) {
                    if (scopeObj.validateData()) {
                        scopeObj.view.flxAddINternationalAccount.setVisibility(false);
            ...
            scopeObj.view.btnModify.onClick = function () {
                scopeObj.view.flxAddINternationalAccount.setVisibility(true);
        ...
        updateFormUI: function (viewModel) {
            ...
            if (viewModel.initialView) {
                this.resetAddInternationalAccount();
            }
        ...
        validateData: function () {
            ...
            if (isNaN(scopeObj.view.tbxAccountNumberKA.text.trim()) || !(scopeObj.view.tbxAccountNumberAgainKA.text.trim() === scopeObj.view.tbxAccountNumberKA.text.trim())) {
                ...
                scopeObj.errorInternational({
                    "errorInternational": errMsg
                });
                return false;
            } else {
                scopeObj.view.tbxSWIFTCodeKA.skin = ViewConstants.SKINS.ACCOUNT_NUMBER_TEXTBOX;
         ...
         */
        validateInternationalAccountFields: function () {
            var errMsg;
            var data = {
                "swiftCode": this.view.tbxSWIFTCodeKA.text.trim(),
            ...
            if (data.beneficiaryName === null || data.accountNumber === "" || data.reAccountNumber === "" || data.beneficiaryName === "" || data.swiftCode === null || data.swiftCode === "") {
        ...
        addInternationalAccount: function () {
            ...
            var combinedUser = applicationManager.getConfigurationManager().isCombinedUser === "true";
            var data = {
                "swiftCode": scopeObj.view.tbxSWIFTCodeKA.text.trim(),
                "bankName": "Infinity",
            ...
            if (!(data.accountNumber === data.reAccountNumber)) {
                ...
                scopeObj.view.btnAddAccountKA.setEnabled(true);
                scopeObj.view.lblWarning.setVisibility(false);
                scopeObj.transfersFastPresentationController.addInternationalAccount(data);
            }
        },
        /**
         * Resets the Account fields
         */
        resetAddInternationalAccount: function () {
            var scopeObj = this;
            scopeObj.view.flxAddINternationalAccount.setVisibility(true);
            scopeObj.view.flxEditInternationalAccount.setVisibility(false);
            scopeObj.view.customheadernew.lblHeaderMobile.text = kony.i18n.getLocalizedString("i18n.FastTransfers.AddInternationalAccount");
            CommonUtilities.setText(scopeObj.view.lblTransfers, kony.i18n.getLocalizedString("i18n.FastTransfers.AddInternationalAccount"), CommonUtilities.getaccessibilityConfig());
            scopeObj.view.tbxSWIFTCodeKA.skin = ViewConstants.SKINS.ACCOUNT_NUMBER_TEXTBOX;
            scopeObj.view.tbxAccountNumberKA.skin = ViewConstants.SKINS.ACCOUNT_NUMBER_TEXTBOX;
            scopeObj.view.tbxAccountNumberAgainKA.skin = ViewConstants.SKINS.ACCOUNT_NUMBER_TEXTBOX;
            scopeObj.view.tbxSWIFTCodeKA.text = "";
        ...
        editDetails: function (data) {
            var scopeObj = this;
            scopeObj.view.flxAddINternationalAccount.setVisibility(false);
            scopeObj.view.flxEditInternationalAccount.setVisibility(true);
            ...
            scopeObj.view.tbxSWIFTCode.text = data.lblAccountTypeValue ? data.lblAccountTypeValue : data.swiftCode;
            ...
            scopeObj.view.tbxSWIFTCode.setEnabled(false);
        ...
        saveChangedAccountDetails(data) {
            ...
            var params = {
                ...
                "swiftCode": data.lblAccountTypeValue ? data.lblAccountTypeValue : data.swiftCode,
         ...
         */
        errorInternational: function (response) {
            var scopeObj = this;
            CommonUtilities.setText(scopeObj.view.lblWarning, response.errorInternational, CommonUtilities.getaccessibilityConfig());
