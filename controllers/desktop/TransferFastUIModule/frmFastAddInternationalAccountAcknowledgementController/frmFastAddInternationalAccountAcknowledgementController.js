    ...
    return {
        ...
        showAddAcknowledgement: function (viewModel) {
            ...
            if (this.profileAccess === "both") {
                ...
                this.view.lblAckRecipientNameValue.left = isTabletDevice ? "3%" : "8.5%";
            }
            ...
            CommonUtilities.setText(scopeObj.view.lblAckSWIFTCodeValue, data.swiftCode, CommonUtilities.getaccessibilityConfig());
        ...
        showEditAcknowledgement: function (data) {
            ...
            scopeObj.view.flxAckSWIFTCode.top = "0dp";
            scopeObj.view.flxAckAccNumber.top = "40dp";
            scopeObj.view.flxAckRecipientName.top = "80dp";
            scopeObj.view.flxAckNickName.top = "120dp";
