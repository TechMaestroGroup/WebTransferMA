define(['FormControllerUtility', 'CommonUtilities', 'ViewConstants', 'OLBConstants'], function (FormControllerUtility, CommonUtilities, ViewConstants, OLBConstants) {
    ...
    return {
         ...
         */
        setInternationalAccount: function (data) {
            var scopeObj = this;
            ...
            viewModel["InternationalAccount"] = data;
            CommonUtilities.setText(scopeObj.view.lblSWIFTCodeValue, data.swiftCode, CommonUtilities.getaccessibilityConfig());
            ...
            scopeObj.view.btnModify.onClick = function () {
                applicationManager.getNavigationManager().navigateTo("frmFastAddInternationalAccount");
            };
