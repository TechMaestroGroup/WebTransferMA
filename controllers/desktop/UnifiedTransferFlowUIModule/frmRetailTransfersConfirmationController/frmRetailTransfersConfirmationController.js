define(['FormControllerUtility', 'CommonUtilities'], function (FormControllerUtility, CommonUtilities) {  
  return {
    ...
    onNavigate: function (param) {
	  ...
	  this.view.confirmation.confirmButtons.btnConfirm.onClick = this.navToAcknowledgement;
	  this.view.confirmation.confirmButtons.btnCancel.onClick = this.navToRTLanding;
	  this.view.btnBackToAccountDeatil.onClick = this.navToRTLanding;
    },
    confirmTransferMFA: function (params) {
	 ...
	 navToAcknowledgement: function(){
		this.view.flxAcknowledgement.setVisibility(true);
		this.view.flxConfirmation.setVisibility(false);
	  },
	  navToRTLanding: function(){
		  var navManager = kony.mvc.getNavigationManager();
      var obj = {
        context: this,
        callbackModelConfig: { "frm": "frmRTLanding", 
        "appName": "TransfersMA" }
      };
      navManager.navigate(obj);
    }, 
    buttonConfirmOnClick: function () {
      var navManager = kony.mvc.getNavigationManager();
      var obj = {
        context: this,
        callbackModelConfig: { "frm": "frmRetailTransferAcknowledgement", 
        "appName": "TransfersMA" }
      };
      navManager.navigate(obj);
    },
