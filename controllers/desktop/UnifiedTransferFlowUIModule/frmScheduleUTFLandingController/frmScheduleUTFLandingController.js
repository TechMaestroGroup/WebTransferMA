define(['FormControllerUtility', 'CommonUtilities'], function (FormControllerUtility, CommonUtilities) {
  ...
  return {
    ...
    postShow: function () {
      ...
      // this.view.UnifiedTransferSelection3.setVisibility(false);
      // this.view.UnifiedTransferSelection4.setVisibility(false);
      // this.view.UnifiedTransferSelection5.setVisibility(false);
      // this.view.UnifiedTransferSelection6.setVisibility(false);
      // this.view.UnifiedTransferSelection7.setVisibility(false);
    ...
    onNavigate: function (data) {
      var scope = this;
      // this.isScheduleForm = data.isScheduleForm;
      ...
      //   scope.flowType(trannsferTypeDetails);
      // };
      // this.view.UnifiedTransferSelection6.transferTypeDetails = function (trannsferTypeDetails) {
      //   scope.flowType(trannsferTypeDetails);
      // };
      // this.view.UnifiedTransferSelection7.transferTypeDetails = function (trannsferTypeDetails) {
      //   scope.flowType(trannsferTypeDetails);
      // };
