define(['CampaignUtility'], function(CampaignUtility){
  ...
  navigateCustomBack: function() {
    ...
    var navMan = applicationManager.getNavigationManager();
     var entryPoint=navMan.getEntryPoint("startFromFlow") || navMan.getEntryPoint("centralmoneymovement") ;
    if(entryPoint==="frmMMTransferFromAccount" || entryPoint==="frmDashboardAggregated" ){
