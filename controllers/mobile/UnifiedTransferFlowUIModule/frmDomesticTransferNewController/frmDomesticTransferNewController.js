define({ 
  ...
  onNavigate: function(params){
    ...
    params = navMan.getCustomInfo("frmDomesticTransferNew");
    ...
    params.transferType = "Domestic Transfer";
...
//         ntf.navigate(response);    
        navMan.setCustomInfo("flxDomesticAcknowledgementNew", response);
        navMan.navigateTo("UnifiedTransferFlowUIModule/flxDomesticAcknowledgementNew");
