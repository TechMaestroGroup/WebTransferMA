define({ 
  ...
  onNavigate: function(params){
    ...
    params = navMan.getCustomInfo("frmInternationalTransferNew");
    ...
    params.transferType = "International Transfer";
  ...
  initActions: function() {
    ...
    scope.view.MakeATransferUTF.onError = function(err) {
...
//         ntf.navigate(response);    
        navMan.setCustomInfo("flxInternationalAcknowledgementNew", response);
        navMan.navigateTo("UnifiedTransferFlowUIModule/flxInternationalAcknowledgementNew");
