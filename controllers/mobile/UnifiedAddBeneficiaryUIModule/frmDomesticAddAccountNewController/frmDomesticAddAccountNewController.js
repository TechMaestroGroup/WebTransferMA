define({ 
  ...
  onNavigate: function(){
    ...
    var params = navMan.getCustomInfo("frmDomesticAddAccountNew");
  ...
  initActions: function() {
    ...
    scope.view.AddNewAccount.createAccountCallback = function(response) {
      ...
      if(!response["MFAAttributes"])
      {
        ...
        navMan.setCustomInfo("flxDomesticNewAccountAckNew", response);
        navMan.navigateTo("UnifiedAddBeneficiaryUIModule/flxDomesticNewAccountAckNew");
