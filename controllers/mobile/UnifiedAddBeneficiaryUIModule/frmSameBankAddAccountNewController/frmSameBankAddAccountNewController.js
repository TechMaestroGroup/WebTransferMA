define({ 
  ...
  onNavigate: function(){
    ...
    var params = navMan.getCustomInfo("frmSameBankAddAccountNew")
  ...
  initActions: function() {
    ...
    scope.view.AddNewAccount.createAccountCallback = function(response) {
      ...
      if(!response["MFAAttributes"])
      {
         ...
         navMan.setCustomInfo("frmSameBankNewAccountAckNew", response);
         navMan.navigateTo("UnifiedAddBeneficiaryUIModule/frmSameBankNewAccountAckNew");
