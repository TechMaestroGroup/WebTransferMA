define({ 
 ...
 //Type your controller code here 
  onNavigate: function(context) {
    ...
    context = navMan.getCustomInfo("frmP2PDeactivationAcknowledgement");
  ...
  initActions:function() {
    ...
    scope.view.flxDeactivateContainer.onScrolling = function() {
  ...
  iPhoneHeaderHandler : function() {
    var scope = this;
    if(scope.view.flxDeactivateContainer.contentOffsetMeasured.y > 50) {
      scope.view.title = kony.i18n.getLocalizedString("i18n.konybb.common.Acknowledgement");
    }
    else if(scope.view.flxDeactivateContainer.contentOffsetMeasured.y < 45) {
      scope.view.title = "";
    }
  },
