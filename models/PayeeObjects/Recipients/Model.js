...
define([], function() {
    ...
    //For Operation 'getBeneficiaryNameFromAccountId' with service id 'getBeneficiaryNameFromAccountId4053'
     Recipients.getBeneficiaryNameFromAccountId = function(params, onCompletion){
        ...
        //For Operation 'getPayeesList' with service id 'getPayeesList1224'
     Recipients.getPayeesList = function(params, onCompletion){
          return Recipients.customVerb('getPayeesList', params, onCompletion);
     };
