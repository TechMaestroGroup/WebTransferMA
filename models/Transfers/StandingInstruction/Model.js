...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "StandingInstruction", "objectService" : "Transfers"};
    ...
    var setterFunctions = {
        ...
        beneficaryName: function(val, state) {
            context["field"] = "beneficaryName";
            context["metadata"] = (objectMetadata ? objectMetadata["beneficaryName"] : null);
            state['beneficaryName'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function StandingInstruction(defaultValues) {
        var privateState = {};
        context["field"] = "accountNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["accountNumber"] : null);
        ...
        context["field"] = "beneficaryName";
        context["metadata"] = (objectMetadata ? objectMetadata["beneficaryName"] : null);
        privateState.beneficaryName = defaultValues ?
            (defaultValues["beneficaryName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["beneficaryName"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "beneficaryName": {
                get: function() {
                    context["field"] = "beneficaryName";
                    context["metadata"] = (objectMetadata ? objectMetadata["beneficaryName"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.beneficaryName, context);
                },
                set: function(val) {
                    setterFunctions['beneficaryName'].call(this, val, privateState);
                },
                enumerable: true,
            },
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.beneficaryName = value ? (value["beneficaryName"] ? value["beneficaryName"] : null) : null;
    ...
    BaseModel.isParentOf(StandingInstruction);

    //Create new class level validator object
    BaseModel.Validator.call(StandingInstruction);

    var registerValidatorBackup = StandingInstruction.registerValidator;

    StandingInstruction.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(StandingInstruction.isValid(this, propName, val)) {
    ...
    //For Operation 'getInstructions' with service id 'GetStandingInstructions7279'
     StandingInstruction.getInstructions = function(params, onCompletion){
        return StandingInstruction.customVerb('getInstructions', params, onCompletion);
     };

    var relations = [];

    StandingInstruction.relations = relations;

    StandingInstruction.prototype.isValid = function() {
        return StandingInstruction.isValid(this);
    };

    StandingInstruction.prototype.objModelName = "StandingInstruction";
     ...
     */
    StandingInstruction.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("Transfers", "StandingInstruction", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    StandingInstruction.clone = function(objectToClone) {
        var clonedObj = new StandingInstruction();
