...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Payee_P2P", "objectService" : "DigitalTransfer"};
    ...
    function Payee_P2P(defaultValues) {
        var privateState = {};
        context["field"] = "lastName";
        context["metadata"] = (objectMetadata ? objectMetadata["lastName"] : null);
    ...
    BaseModel.isParentOf(Payee_P2P);

    //Create new class level validator object
    BaseModel.Validator.call(Payee_P2P);

    var registerValidatorBackup = Payee_P2P.registerValidator;

    Payee_P2P.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(Payee_P2P.isValid(this, propName, val)) {
    ...
    //For Operation 'updateP2PPayee' with service id 'editP2PPayee7115'
     Payee_P2P.updateP2PPayee = function(params, onCompletion){
        return Payee_P2P.customVerb('updateP2PPayee', params, onCompletion);
     };

    //For Operation 'deleteP2PPayee' with service id 'deleteP2PPayee1342'
     Payee_P2P.deleteP2PPayee = function(params, onCompletion){
        return Payee_P2P.customVerb('deleteP2PPayee', params, onCompletion);
     };

    //For Operation 'createP2PPayee' with service id 'createP2PPayee7759'
     Payee_P2P.createP2PPayee = function(params, onCompletion){
        return Payee_P2P.customVerb('createP2PPayee', params, onCompletion);
     };

    //For Operation 'getP2PPayees' with service id 'getP2PPayee1255'
     Payee_P2P.getP2PPayees = function(params, onCompletion){
        return Payee_P2P.customVerb('getP2PPayees', params, onCompletion);
     };

    var relations = [];

    Payee_P2P.relations = relations;

    Payee_P2P.prototype.isValid = function() {
        return Payee_P2P.isValid(this);
    };

    Payee_P2P.prototype.objModelName = "Payee_P2P";
     ...
     */
    Payee_P2P.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("DigitalTransfer", "Payee_P2P", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    Payee_P2P.clone = function(objectToClone) {
        var clonedObj = new Payee_P2P();
